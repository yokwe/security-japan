...
public enum TSE_T_CG {
    ...
    CHAIR_NOMINATION_20150401 (
        ...
        "Chair", 
        "委員長（議長）"), 
    CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ABOARD_OF_CORPORATE_AUDITORS (
        "ChairmanOfTheBoardOfDirectorsCompanyWithABoardOfCorporateAuditors", 
        "Chairman of the board of directors", 
        "取締役会の議長"), 
    CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ABOARD_OF_CORPORATE_AUDITORS_CHECK (
        "ChairmanOfTheBoardOfDirectorsCompanyWithABoardOfCorporateAuditorsCheck", 
        "Chairman of the board of directors", 
        "取締役会の議長"), 
    CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ACOMMITTEE_SYSTEMS (
        "ChairmanOfTheBoardOfDirectorsCompanyWithACommitteeSystems", 
        "Chairman of the board of directors", 
        "取締役会の議長"), 
    CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ACOMMITTEE_SYSTEMS_CHECK (
    ...
    CORRESPONDENCE_WEBSITE (
        ...
        "Correspondence", 
        "該当"), 
    DATE_WHEN_FORMER_ROLE_AS_PRESIDENT_OR_CEOENDED_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    DIRECTOR_EXECUTIVE_OFFICER_COMPENSATION_ABSTRACT (
        ...
        "取締役・執行役報酬関係"), 
    DIRECTOR_SCOMPENSATION_ABSTRACT (
    ...
    DISCLOSURE_OF_EXECUTIVE_OFFICERS_COMPENSATION_CHECK (
        ...
        "Disclosure of executive officers' compensation", 
        "（個別の執行役報酬の）開示状況"), 
    DISCLOSURE_OF_IRDOCUMENTS_ON_THE_WEBSITE_ABSTRACT (
    ...
    EMPLOYEES_OF_SUBSIDIARIES (
        ...
        "子会社の従業員"), 
    EMPLOYMENT_TERMS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    ESTABLISHMENT_OR_NON_ESTABLISHMENT_OF_ABOARD_OF_CORPORATE_AUDITORS (
        ...
        "監査役会の設置の有無"), 
    ESTABLISHMENT_OR_NONESTABLISHMENT_OF_ABOARD_OF_CORPORATE_AUDITORS_CHECK (
    ...
    EXISTANCE_OF_PARENT_COMPANY_CHECK (
        ...
        "Existance of parent company", 
        "親会社の有無"), 
    EXISTENCE_OF_ACONTROLLING_SHAREHOLDERS (
        "ExistenceOfAControllingShareholders", 
        "Existence of a controlling shareholder(s)", 
        "支配株主（親会社を除く）の有無"), 
    EXISTENCE_OF_ACONTROLLING_SHAREHOLDERS_CHECK (
    ...
    IRACTIVITIES_CHECK (
        ...
        "IR activities", 
        "ＩＲに関する活動状況"), 
    IRRELATED_DIVISIONS_PERSONNEL_ABSTRACT (
    ...
    INDIVIDUAL_COMMITTEES_ABSTRACT (
        ...
        "各種委員会"), 
    INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_ABSTRACT (
    ...
    INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK (
        "InformationOnRetiredPresidentsOrCEOsHoldingAdvisoryPositionsCheck", 
        "Information on retired presidents/CEOs holding advisory positions (sodanyaku, komon, etc.)", 
        "元代表取締役社長等である相談役・顧問等の氏名等"), 
    INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_INCLUDED_OR_OMITTED (
    ...
    JASDAQNEO (
        ...
        "JASDAQ NEO", 
        "ジャスダック NEO"), 
    JASDAQSTOCK_EXCHANGE_PARENT_COMPANY (
    ...
    JAPAN_SECURITIES_DEALERS_ASSOCIATION_PARENT_COMPANY (
        ...
        "Japan Securities Dealers Association", 
        "グリーンシート等"), 
    JOB_TITLE_OR_POSITION_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    MATTERS_PERTAINING_TO_FUNCTIONS_RELATING_TO_THE_EXECUTION_OF_DUTIES_AUDIT_AND_SUPERVISION_APPOINTMENT_AND_DECISIONS_REGARDING_COMPENSATION_ETC_CHECK (
        ...
        "Matters pertaining to functions relating to the execution of duties, audit and supervision, appointment and decisions regarding compensation, etc (overview of the current corporate governance system)", 
        "業務執行、監査・監督、指名、報酬決定等の機能に係る事項（現状のコーポレート・ガバナンス体制の概要）"), 
    MATTERS_REGARDING_DEFENSE_AGAINST_ATAKEOVER_BID (
        "MattersRegardingDefenseAgainstATakeoverBid", 
        "Supplementary information", 
        "該当項目に関する補足説明"), 
    MATTERS_REGARDING_DEFENSE_AGAINST_ATAKEOVER_BID_CHECK (
    ...
    NAME_OUTSIDE_DIRECTORS (
        ...
        "Name", 
        "氏名"), 
    NAME_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    NUMBER_OF_OUTSIDE_INTELLECTUALS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE (
        ...
        "Number of outside intellectuals", 
        "社外有識者（名）"), 
    NUMBER_OF_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    NUMBER_OF_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK (
    ...
    OTHERS_ABSTRACT (
        ...
        "Others", 
        "その他"), 
    OTHERS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
        "OthersRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Others", 
        "その他の事項"), 
    OTHERS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK (
    ...
    PERFORMANCE_BASED_COMPENSATION_SYSTEM (
        ...
        "業績連動報酬制度の導入"), 
    PROMOTION_OF_ENVIRONMENTAL_PRESERVATION_ACTIVITIES_AND_CSRACTIVITIES_ABSTRACT (
    ...
    REASON_FOR_ELECTION_AS_OUTSIDE_DIRECTORS (
        ...
        "Reasons for appointment", 
        "選任の理由"), 
    REASONS_FOR_IMPLEMENTING_THE_FORMAT_OF_ACOMPANY_WITH_ACOMMITTEES_SYSTEM (
        ...
        "委員会設置会社形態を採用している理由"), 
    REASONS_FOR_IMPLEMENTING_THE_FORMAT_OF_ACOMPANY_WITH_ACOMMITTEES_SYSTEM_CHECK (
    ...
    REASONS_FOR_NON_COMPLIANCE_WITH_THE_PRINCIPLES_OF_THE_CORPORATE_GOVERNANCE_CODE_CHECK (
        ...
        "Reasons for non-compliance with the principles of the Corporate Governance Code", 
        "コーポレートガバナンス・コードの各原則を実施しない理由"), 
    RECEIVES_COMPENSATION_ETC_OR_OTHER_PROFITS_ON_ASSETS_FROM_THE_PARENT_COMPANY_OF_THE_COMPANY_OR_ASUBSIDIARY_OF_SUCH_PARENT_COMPANY_AS_AN_OFFICER_OUTSIDE_CORPORATE_AUDITORS (
    ...
    RECEIVES_COMPENSATION_ETC_OR_OTHER_PROFITS_ON_ASSETS_FROM_THE_PARENT_COMPANY_OF_THE_COMPANY_OR_ASUBSIDIARY_OF_SUCH_PARENT_COMPANY_AS_AN_OFFICER_OUTSIDE_DIRECTORS (
    ...
    RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_ABSTRACT (
        ...
        "Relation with the company (2)", 
        "会社との関係(2)"), 
    RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CAABSTRACT (
        "RelationWithTheCompany2OutsideDirectorsCAAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)"), 
    RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CACHECK (
        "RelationWithTheCompany2OutsideDirectorsCACheck", 
        "Relation with the company (2)", 
        "会社との関係(2)"), 
    RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CMABSTRACT (
        "RelationWithTheCompany2OutsideDirectorsCMAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)"), 
    RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CMCHECK (
    ...
    REPRESENTATIVE_AUTHORITY (
        ...
        "代表権の有無"), 
    REPRESENTATIVE_STITLE_AND_NAME (
        "RepresentativeSTitleAndName", 
        "Representative's title and name", 
        "代表者役職氏名"), 
    RESPONSIBILITIES_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
        "ResponsibilitiesRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Responsibilities", 
        "業務内容"), 
    RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_ABSTRACT (
    ...
    SUPPLEMENTARY_INFORMATION_CONCENTRATED_DAYS (
        ...
        "Supplementary information", 
        "補足説明"), 
    SUPPLEMENTARY_INFORMATION_DEFENSE_AGAINST_ATAKEOVER_BID (
        "SupplementaryInformationDefenseAgainstATakeoverBid", 
        "Supplementary information", 
        "該当項目に関する補足説明"), 
    SUPPLEMENTARY_INFORMATION_DEFENSE_AGAINST_ATAKEOVER_BID_CHECK (
    ...
    SUPPLEMENTARY_INFORMATION_GRANTEES_OF_STOCK_OPTIONS_CHECK (
        ...
        "Supplementary information", 
        "該当項目に関する補足説明"), 
    SUPPLEMENTARY_INFORMATION_IRDIVISIONS (
    ...
    SUPPORT_SYSTEM_FOR_OUTSIDE_DIRECTORS_OUTSIDE_CORPORATE_AUDITORS_CHECK (
        ...
        "Support system for outside directors (outside corporate auditors)", 
        "社外取締役（社外監査役）のサポート体制"), 
    TERM_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS (
    ...
    public static final Map<String, TSE_T_CG> NAME_MAP = new TreeMap<>();
    public static final TSE_T_CG get(String name) {
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TSE_T_CG.class);
    private static void addNameMap(TSE_T_CG e) {
