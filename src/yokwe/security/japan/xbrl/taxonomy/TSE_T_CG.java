...
public class TSE_T_CG extends TaxonomyData {
    ...
    public static final TSE_T_CG ACTIVITIES_CONCERNING_RESPECT_FOR_STAKEHOLDERS_CHECK = new TSE_T_CG(
        "ActivitiesConcerningRespectForStakeholdersCheck", 
        "Activities concerning respect for stakeholders", 
        "ステークホルダーの立場の尊重に係る取組み状況");
    public static final TSE_T_CG ADDITIONAL_DUTIES_AS_DIRECTOR = new TSE_T_CG(
        "AdditionalDutiesAsDirector", 
        "Additional duties as director", 
        "取締役との兼任の有無");
    public static final TSE_T_CG ADDITIONAL_DUTIES_AS_EMPLOYEE = new TSE_T_CG(
        "AdditionalDutiesAsEmployee", 
        "Additional duties as employee", 
        "使用人との兼任の有無");
    public static final TSE_T_CG ANNUAL_SECURITIES_REPORT = new TSE_T_CG(
        "AnnualSecuritiesReport", 
        "Annual securities report", 
        "有価証券報告書");
    public static final TSE_T_CG ATTRIBUTION_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "AttributionOutsideCorporateAuditors", 
        "Attribution", 
        "属性");
    public static final TSE_T_CG ATTRIBUTION_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "AttributionOutsideDirectors", 
        "Attribution", 
        "属性");
    public static final TSE_T_CG AUDIT_COMMITTEE_ABSTRACT = new TSE_T_CG(
        "AuditCommitteeAbstract", 
        "Audit committee", 
        "監査委員会");
    public static final TSE_T_CG AUDIT_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "AuditCommitteeOutsideDirectors", 
        "Audit committee", 
        "監査委員会");
    public static final TSE_T_CG AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "AuditEtcCommitteeOutsideDirectors", 
        "Audit etc. committee member", 
        "監査等委員");
    public static final TSE_T_CG AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "AuditEtcCommitteeOutsideDirectorsAbstract", 
        "Audit etc. committee", 
        "監査等委員会");
    public static final TSE_T_CG AUDITING_STRUCTURE_ABSTRACT = new TSE_T_CG(
        "AuditingStructureAbstract", 
        "Auditing structure", 
        "監査体制");
    public static final TSE_T_CG AUDITORS_ABSTRACT = new TSE_T_CG(
        "AuditorsAbstract", 
        "Auditors", 
        "監査役関係");
    public static final TSE_T_CG AUDITORS_OF_PARENT_COMPANY = new TSE_T_CG(
        "AuditorsOfParentCompany", 
        "Auditors of parent company", 
        "親会社の監査役");
    public static final TSE_T_CG AUDITORS_OF_SUBSIDIARIES = new TSE_T_CG(
        "AuditorsOfSubsidiaries", 
        "Auditors of subsidiaries", 
        "子会社の監査役");
    public static final TSE_T_CG AVAILABILITY_OF_ENGLISH_TRANSLATION_OF_GENERAL_SHAREHOLDERS_MEETING_NOTICE = new TSE_T_CG(
        "AvailabilityOfEnglishTranslationOfGeneralShareholdersMeetingNotice", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG AVAILABILITY_OF_ENGLISH_TRANSLATION_OF_GENERAL_SHAREHOLDERS_MEETING_NOTICE_ABSTRACT = new TSE_T_CG(
        ...
        "招集通知（要約）の英文での提供");
    public static final TSE_T_CG BASIC_APPROACH_TO_INTERNAL_CONTROL_SYSTEM_AND_ITS_DEVELOPMENT = new TSE_T_CG(
        "BasicApproachToInternalControlSystemAndItsDevelopment", 
        "Basic approach to internal control system and its development", 
        "内部統制システムに関する基本的な考え方及びその整備状況");
    public static final TSE_T_CG BASIC_APPROACH_TO_INTERNAL_CONTROL_SYSTEM_AND_ITS_DEVELOPMENT_CHECK = new TSE_T_CG(
        "BasicApproachToInternalControlSystemAndItsDevelopmentCheck", 
        "Basic approach to internal control system and its development", 
        "内部統制システムに関する基本的な考え方及びその整備状況");
    public static final TSE_T_CG BASIC_POLICY = new TSE_T_CG(
        "BasicPolicy", 
        "Basic policy", 
        "基本的な考え方");
    public static final TSE_T_CG BASIC_POLICY_CHECK = new TSE_T_CG(
        "BasicPolicyCheck", 
        "Basic policy", 
        "基本的な考え方");
    public static final TSE_T_CG BASIC_POLICY_ON_CORPORATE_GOVERNANCE_AND_CAPITAL_STRUCTURE_BUSINESS_ATTRIBUTES_AND_OTHER_BASIC_INFORMATION_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG BASIC_POLICY_TO_REJECT_ANTISOCIAL_FORCES_AND_THE_PROGRESS_OF_DEVELOPMENT = new TSE_T_CG(
    ...
    public static final TSE_T_CG BASIC_POLICY_TO_REJECT_ANTISOCIAL_FORCES_AND_THE_PROGRESS_OF_DEVELOPMENT_CHECK = new TSE_T_CG(
        "BasicPolicyToRejectAntisocialForcesAndTheProgressOfDevelopmentCheck", 
        "Basic policy to reject antisocial forces and the progress of development", 
        "反社会的勢力排除に向けた基本的な考え方及びその整備状況");
    public static final TSE_T_CG BUSINESS_ATTRIBUTES_ABSTRACT = new TSE_T_CG(
        "BusinessAttributesAbstract", 
        "Business attributes", 
        "企業属性");
    public static final TSE_T_CG BUSINESS_REPORT = new TSE_T_CG(
        "BusinessReport", 
        "Business report", 
        "営業報告書（事業報告）");
    public static final TSE_T_CG CAPITAL_STRUCTURE_ABSTRACT = new TSE_T_CG(
        "CapitalStructureAbstract", 
        "Capital structure", 
        "資本構成");
    public static final TSE_T_CG CHAIR_AUDIT = new TSE_T_CG(
        "ChairAudit", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_AUDIT_20150401 = new TSE_T_CG(
        "ChairAudit20150401", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ChairAuditEtcCommitteeOutsideDirectors", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "ChairCommitteeCorrespondingToCompensationCommittee", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "ChairCommitteeCorrespondingToNominatingCommittee", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_COMPENSATION = new TSE_T_CG(
        "ChairCompensation", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_COMPENSATION_20150401 = new TSE_T_CG(
        "ChairCompensation20150401", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_NOMINATION = new TSE_T_CG(
        "ChairNomination", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIR_NOMINATION_20150401 = new TSE_T_CG(
        "ChairNomination20150401", 
        "Chair", 
        "委員長（議長）");
    public static final TSE_T_CG CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ABOARD_OF_CORPORATE_AUDITORS = new TSE_T_CG(
        "ChairmanOfTheBoardOfDirectorsCompanyWithABoardOfCorporateAuditors", 
        "Chairman of the board of directors", 
        "取締役会の議長");
    public static final TSE_T_CG CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ABOARD_OF_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "ChairmanOfTheBoardOfDirectorsCompanyWithABoardOfCorporateAuditorsCheck", 
        "Chairman of the board of directors", 
        "取締役会の議長");
    public static final TSE_T_CG CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ACOMMITTEE_SYSTEMS = new TSE_T_CG(
        "ChairmanOfTheBoardOfDirectorsCompanyWithACommitteeSystems", 
        "Chairman of the board of directors", 
        "取締役会の議長");
    public static final TSE_T_CG CHAIRMAN_OF_THE_BOARD_OF_DIRECTORS_COMPANY_WITH_ACOMMITTEE_SYSTEMS_CHECK = new TSE_T_CG(
        "ChairmanOfTheBoardOfDirectorsCompanyWithACommitteeSystemsCheck", 
        "Chairman of the board of directors", 
        "取締役会の議長");
    public static final TSE_T_CG COMES_FROM_OTHER_AFFILIATE_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "ComesFromOtherAffiliateCompanyOutsideCorporateAuditors", 
        "Comes from other affiliate company", 
        "その他の関係会社出身である");
    public static final TSE_T_CG COMES_FROM_OTHER_AFFILIATE_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ComesFromOtherAffiliateCompanyOutsideDirectors", 
        "Comes from other affiliate company", 
        "他の関係会社出身である");
    public static final TSE_T_CG COMES_FROM_PARENT_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "ComesFromParentCompanyOutsideCorporateAuditors", 
        "Comes from parent company", 
        "親会社出身である");
    public static final TSE_T_CG COMES_FROM_PARENT_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ComesFromParentCompanyOutsideDirectors", 
        "Comes from parent company", 
        "親会社出身である");
    public static final TSE_T_CG COMMITTEE_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_ABSTRACT = new TSE_T_CG(
        "CommitteeCompositionAndAttributesOfChairAbstract", 
        "Committee composition and attributes of chair", 
        "各委員会の委員構成及び議長の属性");
    public static final TSE_T_CG COMMITTEE_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_CHECK = new TSE_T_CG(
        "CommitteeCompositionAndAttributesOfChairCheck", 
        "Committee composition and attributes of chair", 
        "各委員会の委員構成及び議長の属性");
    public static final TSE_T_CG COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE_ABSTRACT = new TSE_T_CG(
        "CommitteeCorrespondingToCompensationCommitteeAbstract", 
        "Committee corresponding to compensation committee", 
        "報酬委員会に相当する任意の委員会");
    public static final TSE_T_CG COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE_ABSTRACT = new TSE_T_CG(
        "CommitteeCorrespondingToNominatingCommitteeAbstract", 
        "Committee corresponding to nominating committee", 
        "指名委員会に相当する任意の委員会");
    public static final TSE_T_CG COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE_OR_COMPENSATION_COMMITTEE = new TSE_T_CG(
    ...
    public static final TSE_T_CG COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE_OR_COMPENSATION_COMMITTEE_CHECK = new TSE_T_CG(
        "CommitteeCorrespondingToNominatingCommitteeOrCompensationCommitteeCheck", 
        "Committee corresponding to nominating committee or compensation committee", 
        "指名委員会又は報酬委員会に相当する任意の委員会の有無");
    public static final TSE_T_CG COMMITTEES_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_ABSTRACT = new TSE_T_CG(
        "CommitteesCompositionAndAttributesOfChairAbstract", 
        "Committees composition and attributes of chair", 
        "委員構成及び議長の属性");
    public static final TSE_T_CG COMMITTEES_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_CHECK = new TSE_T_CG(
        "CommitteesCompositionAndAttributesOfChairCheck", 
        "Committees composition and attributes of chair", 
        "委員構成及び議長の属性");
    public static final TSE_T_CG COMMITTEES_VOLUNTARILY_ESTABLISHED_ABSTRACT = new TSE_T_CG(
        "CommitteesVoluntarilyEstablishedAbstract", 
        "Committees voluntarily established", 
        "任意の委員会");
    public static final TSE_T_CG COMPANY_NAME = new TSE_T_CG(
        "CompanyName", 
        "Company name", 
        "会社名");
    public static final TSE_T_CG COMPANY_NAME_EN = new TSE_T_CG(
        "CompanyNameEn", 
        "Company name (English)", 
        "会社名（英訳名）");
    public static final TSE_T_CG COMPENSATION_COMMITTEE_ABSTRACT = new TSE_T_CG(
        "CompensationCommitteeAbstract", 
        "Compensation committee", 
        "報酬委員会");
    public static final TSE_T_CG COMPENSATION_COMMITTEE_MEMBER = new TSE_T_CG(
        "CompensationCommitteeMember", 
        "Compensation committee member", 
        "報酬委員");
    public static final TSE_T_CG COMPENSATION_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "CompensationCommitteeOutsideDirectors", 
        "Compensation committee", 
        "報酬委員会");
    public static final TSE_T_CG CONCURRENTLY_HOLDS_OFFICE_AS_OUTSIDE_DIRECTOR_OR_OUTSIDE_CORPORATE_AUDITOR_OF_ANOTHER_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG CONCURRENTLY_HOLDS_OFFICE_AS_OUTSIDE_DIRECTOR_OR_OUTSIDE_CORPORATE_AUDITOR_OF_ANOTHER_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ConcurrentlyHoldsOfficeAsOutsideDirectorOrOutsideCorporateAuditorOfAnotherCompanyOutsideDirectors", 
        "Concurrently holds office as outside director or outside corporate auditor of another company", 
        "他の会社の社外取締役又は社外監査役を兼任している");
    public static final TSE_T_CG CONTACT = new TSE_T_CG(
        "Contact", 
        "Contact", 
        "問合せ先");
    public static final TSE_T_CG CONTROLLING_SHAREHOLDER = new TSE_T_CG(
        "ControllingShareholder", 
        "Controlling shareholder", 
        "支配株主名");
    public static final TSE_T_CG CONVENE_PERIODIC_BRIEFING_FOR_ANALYSTS_AND_INSTITUTIONAL_INVESTORS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG CONVENE_PERIODIC_BRIEFING_FOR_FOREIGN_INVESTORS_ABSTRACT = new TSE_T_CG(
        "ConvenePeriodicBriefingForForeignInvestorsAbstract", 
        "Convene periodic briefing for foreign investors", 
        "海外投資家向けに定期的説明会を開催");
    public static final TSE_T_CG CONVENE_PERIODIC_BRIEFING_FOR_INDIVIDUAL_INVESTORS_ABSTRACT = new TSE_T_CG(
        "ConvenePeriodicBriefingForIndividualInvestorsAbstract", 
        "Convene periodic briefing for individual investors", 
        "個人投資家向けに定期的説明会を開催");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_CORPORATE_AUDITORS_INDEPENDENT_ACCOUNTANTS_AND_INTERNAL_AUDIT_DIVISION = new TSE_T_CG(
    ...
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_CORPORATE_AUDITORS_INDEPENDENT_ACCOUNTANTS_AND_INTERNAL_AUDIT_DIVISION_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsAmongCorporateAuditorsIndependentAccountantsAndInternalAuditDivisionCheck", 
        "Cooperative relationships among corporate auditors,  independent accountants and internal audit division", 
        "監査役、会計監査人、内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_THE_AUDIT_COMMITTEE_INDEPENDENT_AUDITORS_AND_INTERNAL_AUDIT_DIVISION = new TSE_T_CG(
    ...
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_THE_AUDIT_COMMITTEE_INDEPENDENT_AUDITORS_AND_INTERNAL_AUDIT_DIVISION_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsAmongTheAuditCommitteeIndependentAuditorsAndInternalAuditDivisionCheck", 
        "Cooperative relationships among the audit committee, independent auditors and internal audit division", 
        "監査委員会、会計監査人、内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_THE_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS_INDEPENDENT_AUDITORS_AND_INTERNAL_AUDIT_DIVISION = new TSE_T_CG(
    ...
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_AMONG_THE_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS_INDEPENDENT_AUDITORS_AND_INTERNAL_AUDIT_DIVISION_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsAmongTheAuditEtcCommitteeOutsideDirectorsIndependentAuditorsAndInternalAuditDivisionCheck", 
        "Cooperative relationships among the audit etc. committee, independent auditors and internal audit division", 
        "監査等委員会、会計監査人、内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_CORPORATE_AUDITORS_AND_INDEPENDENT_ACCOUNTANTS = new TSE_T_CG(
        ...
        "監査役と会計監査人の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_CORPORATE_AUDITORS_AND_INDEPENDENT_ACCOUNTANTS_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsBetweenCorporateAuditorsAndIndependentAccountantsCheck", 
        "Cooperative relationships between corporate auditors and independent accountants", 
        "監査役と会計監査人の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_CORPORATE_AUDITORS_AND_INTERNAL_AUDIT_DIVISION = new TSE_T_CG(
        ...
        "監査役と内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_CORPORATE_AUDITORS_AND_INTERNAL_AUDIT_DIVISION_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsBetweenCorporateAuditorsAndInternalAuditDivisionCheck", 
        "Cooperative relationships between corporate auditors and internal audit division", 
        "監査役と内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_THE_AUDIT_COMMITTEE_AND_ACCOUNTING_AUDITORS = new TSE_T_CG(
        ...
        "監査委員会と会計監査人の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_THE_AUDIT_COMMITTEE_AND_ACCOUNTING_AUDITORS_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsBetweenTheAuditCommitteeAndAccountingAuditorsCheck", 
        "Cooperative relationships between the audit committee and accounting auditors", 
        "監査委員会と会計監査人の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_THE_AUDIT_COMMITTEE_AND_THE_INTERNAL_AUDIT_DIVISION = new TSE_T_CG(
        ...
        "監査委員会と内部監査部門の連携状況");
    public static final TSE_T_CG COOPERATIVE_RELATIONSHIPS_BETWEEN_THE_AUDIT_COMMITTEE_AND_THE_INTERNAL_AUDIT_DIVISION_CHECK = new TSE_T_CG(
        "CooperativeRelationshipsBetweenTheAuditCommitteeAndTheInternalAuditDivisionCheck", 
        "Cooperative relationships between the audit committee and the internal audit division", 
        "監査委員会と内部監査部門の連携状況");
    public static final TSE_T_CG CORPORATE_GOVERNANCE_REPORT_ABSTRACT = new TSE_T_CG(
        "CorporateGovernanceReportAbstract", 
        "Corporate governance report", 
        "コーポレート・ガバナンスに関する報告書");
    public static final TSE_T_CG CORPORATE_GOVERNANCE_SYSTEM_OF_MANAGEMENT_BUSINESS_ORGANIZATION_ETC_FOR_MANAGEMENT_DECISION_MAKING_EXECUTION_OF_DUTIES_AND_MANAGEMENT_AUDIT_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG CORRESPONDENCE_ANALYSTS_AND_INSTITUTIONAL_INVESTORS = new TSE_T_CG(
        "CorrespondenceAnalystsAndInstitutionalInvestors", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_CSR = new TSE_T_CG(
        "CorrespondenceCSR", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_CONCENTRATED_DAYS = new TSE_T_CG(
        "CorrespondenceConcentratedDays", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_DISCLOSURE_OF_INFORMATION = new TSE_T_CG(
        "CorrespondenceDisclosureOfInformation", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_ELECTRONIC_EXECUTION = new TSE_T_CG(
        "CorrespondenceElectronicExecution", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_FOREIGN_INVESTORS = new TSE_T_CG(
        "CorrespondenceForeignInvestors", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_IRDIVISIONS = new TSE_T_CG(
        "CorrespondenceIRDivisions", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_INDIVIDUAL_INVESTORS = new TSE_T_CG(
        "CorrespondenceIndividualInvestors", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_INTERNAL_REGULATIONS = new TSE_T_CG(
        "CorrespondenceInternalRegulations", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_NOT_ACTED_IR = new TSE_T_CG(
        "CorrespondenceNotActedIR", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_NOT_ACTED_STAKEHOLDERS = new TSE_T_CG(
        "CorrespondenceNotActedStakeholders", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_NOT_IMPLEMENTED_SHAREHOLDERS_MEETING = new TSE_T_CG(
        "CorrespondenceNotImplementedShareholdersMeeting", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_OTHER_IR = new TSE_T_CG(
        "CorrespondenceOtherIR", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_OTHER_SHAREHOLDERS_MEETING = new TSE_T_CG(
        "CorrespondenceOtherShareholdersMeeting", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_OTHER_STAKEHOLDERS = new TSE_T_CG(
        "CorrespondenceOtherStakeholders", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_SHAREHOLDERS_MEETING = new TSE_T_CG(
        "CorrespondenceShareholdersMeeting", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG CORRESPONDENCE_WEBSITE = new TSE_T_CG(
        "CorrespondenceWebsite", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG DATE_WHEN_FORMER_ROLE_AS_PRESIDENT_OR_CEOENDED_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        ...
        "社長等退任日");
    public static final TSE_T_CG DESCRIPTION_OF_CONTROLLING_SHAREHOLDERS_AND_PARENT_COMPANY_ABSTRACT = new TSE_T_CG(
        "DescriptionOfControllingShareholdersAndParentCompanyAbstract", 
        "Description of controlling shareholders and parent company", 
        "支配株主並びに親会社の状況");
    public static final TSE_T_CG DESCRIPTION_OF_MAJOR_SHAREHOLDERS_ABSTRACT = new TSE_T_CG(
        "DescriptionOfMajorShareholdersAbstract", 
        "Description of major shareholders", 
        "大株主の状況");
    public static final TSE_T_CG DESCRIPTION_OF_MAJOR_SHAREHOLDERS_CHECK = new TSE_T_CG(
        "DescriptionOfMajorShareholdersCheck", 
        "Description of major shareholders", 
        "大株主の状況");
    public static final TSE_T_CG DIAGRAM_1 = new TSE_T_CG(
        "Diagram1", 
        "diagram1", 
        "模式図1");
    public static final TSE_T_CG DIAGRAM_2 = new TSE_T_CG(
        "Diagram2", 
        "diagram2", 
        "模式図2");
    public static final TSE_T_CG DIAGRAM_3 = new TSE_T_CG(
        "Diagram3", 
        "diagram3", 
        "模式図3");
    public static final TSE_T_CG DIAGRAM_4 = new TSE_T_CG(
        "Diagram4", 
        "diagram4", 
        "模式図4");
    public static final TSE_T_CG DIAGRAM_5 = new TSE_T_CG(
        "Diagram5", 
        "diagram5", 
        "模式図5");
    public static final TSE_T_CG DIAGRAM_ABSTRACT = new TSE_T_CG(
        "DiagramAbstract", 
        "diagram", 
        "模式図");
    public static final TSE_T_CG DIRECTOR_COMPENSATION_DISCLOSURE_STATUS = new TSE_T_CG(
        "DirectorCompensationDisclosureStatus", 
        "Director compensation disclosure status", 
        "取締役報酬の開示状況");
    public static final TSE_T_CG DIRECTOR_COMPENSATION_DISCLOSURE_STATUS_CHECK = new TSE_T_CG(
        "DirectorCompensationDisclosureStatusCheck", 
        "Director compensation disclosure status", 
        "取締役報酬の開示状況");
    public static final TSE_T_CG DIRECTOR_EXECUTIVE_OFFICER_COMPENSATION_ABSTRACT = new TSE_T_CG(
        "DirectorExecutiveOfficerCompensationAbstract", 
        "Director/executive officer compensation", 
        "取締役・執行役報酬関係");
    public static final TSE_T_CG DIRECTOR_SCOMPENSATION_ABSTRACT = new TSE_T_CG(
        "DirectorSCompensationAbstract", 
        "Director's compensation", 
        "取締役報酬関係");
    public static final TSE_T_CG DIRECTORS_ABSTRACT = new TSE_T_CG(
        "DirectorsAbstract", 
        "Directors", 
        "取締役関係");
    public static final TSE_T_CG DIRECTORS_AND_EMPLOYEES_RESPONSIBLE_FOR_ASSISTING_IN_EXECUTION_OF_THE_DUTIES_OF_THE_AUDIT_COMMITTEE = new TSE_T_CG(
    ...
    public static final TSE_T_CG DIRECTORS_AND_EMPLOYEES_RESPONSIBLE_FOR_ASSISTING_IN_EXECUTION_OF_THE_DUTIES_OF_THE_AUDIT_COMMITTEE_CHECK = new TSE_T_CG(
        "DirectorsAndEmployeesResponsibleForAssistingInExecutionOfTheDutiesOfTheAuditCommitteeCheck", 
        "Directors and employees responsible for assisting in execution of the duties of the audit committee", 
        "監査委員会の職務を補助すべき取締役及び使用人の有無");
    public static final TSE_T_CG DIRECTORS_AND_EMPLOYEES_RESPONSIBLE_FOR_ASSISTING_IN_EXECUTION_OF_THE_DUTIES_OF_THE_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG DIRECTORS_AND_EMPLOYEES_RESPONSIBLE_FOR_ASSISTING_IN_EXECUTION_OF_THE_DUTIES_OF_THE_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "DirectorsAndEmployeesResponsibleForAssistingInExecutionOfTheDutiesOfTheAuditEtcCommitteeOutsideDirectorsCheck", 
        "Directors and employees responsible for assisting in execution of the duties of the audit etc. committee", 
        "監査等委員会の職務を補助すべき取締役及び使用人の有無");
    public static final TSE_T_CG DIRECTORS_EXECUTIVE_OFFICERS_AUDITORS_OF_PARENT_COMPANY = new TSE_T_CG(
        "DirectorsExecutiveOfficersAuditorsOfParentCompany", 
        "Directors, executive officers, auditors of parent company", 
        "親会社の取締役、執行役、監査役");
    public static final TSE_T_CG DIRECTORS_EXECUTIVE_OFFICERS_AUDITORS_OF_SUBSIDIARIES = new TSE_T_CG(
        "DirectorsExecutiveOfficersAuditorsOfSubsidiaries", 
        "Directors, executive officers, auditors of subsidiaries", 
        "子会社の取締役、執行役、監査役");
    public static final TSE_T_CG DIRECTORS_OF_PARENT_COMPANY = new TSE_T_CG(
        "DirectorsOfParentCompany", 
        "Directors of parent company", 
        "親会社の取締役");
    public static final TSE_T_CG DIRECTORS_OF_SUBSIDIARIES = new TSE_T_CG(
        "DirectorsOfSubsidiaries", 
        "Directors of subsidiaries", 
        "子会社の取締役");
    public static final TSE_T_CG DIRECTORS_TERM_OF_OFFICE_STIPULATED_IN_ARTICLES_OF_INCORPORATION = new TSE_T_CG(
        ...
        "定款上の取締役の任期");
    public static final TSE_T_CG DIRECTORS_TERM_OF_OFFICE_STIPULATED_IN_ARTICLES_OF_INCORPORATION_CHECK = new TSE_T_CG(
        "DirectorsTermOfOfficeStipulatedInArticlesOfIncorporationCheck", 
        "Director's term of office stipulated in articles of incorporation", 
        "定款上の取締役の任期");
    public static final TSE_T_CG DISCLOSURE_OF_DIRECTORS_COMPENSATION = new TSE_T_CG(
        "DisclosureOfDirectorsCompensation", 
        "Disclosure of directors' compensation", 
        "（個別の取締役報酬の）開示状況");
    public static final TSE_T_CG DISCLOSURE_OF_DIRECTORS_COMPENSATION_CHECK = new TSE_T_CG(
        "DisclosureOfDirectorsCompensationCheck", 
        "Disclosure of directors' compensation", 
        "（個別の取締役報酬の）開示状況");
    public static final TSE_T_CG DISCLOSURE_OF_EXECUTIVE_OFFICERS_COMPENSATION = new TSE_T_CG(
        "DisclosureOfExecutiveOfficersCompensation", 
        "Disclosure of executive officers' compensation", 
        "（個別の執行役報酬の）開示状況");
    public static final TSE_T_CG DISCLOSURE_OF_EXECUTIVE_OFFICERS_COMPENSATION_CHECK = new TSE_T_CG(
        "DisclosureOfExecutiveOfficersCompensationCheck", 
        "Disclosure of executive officers' compensation", 
        "（個別の執行役報酬の）開示状況");
    public static final TSE_T_CG DISCLOSURE_OF_IRDOCUMENTS_ON_THE_WEBSITE_ABSTRACT = new TSE_T_CG(
        "DisclosureOfIRDocumentsOnTheWebsiteAbstract", 
        "Disclosure of IR documents on the website", 
        "IR資料のホームページ掲載");
    public static final TSE_T_CG DISCLOSURE_OF_METHODS_TO_DETERMINE_COMPENSATION_OR_COMPENSATION_POLICIES = new TSE_T_CG(
    ...
    public static final TSE_T_CG DISCLOSURE_OF_METHODS_TO_DETERMINE_COMPENSATION_OR_COMPENSATION_POLICIES_CHECK = new TSE_T_CG(
        "DisclosureOfMethodsToDetermineCompensationOrCompensationPoliciesCheck", 
        "Disclosure of methods to determine compensation or compensation policies", 
        "報酬の額又はその算定方法の決定方針の開示内容");
    public static final TSE_T_CG DISCLOSURE_STATUS = new TSE_T_CG(
        "DisclosureStatus", 
        "Disclosure status", 
        "開示状況");
    public static final TSE_T_CG DISCLOSURE_STATUS_CHECK = new TSE_T_CG(
        "DisclosureStatusCheck", 
        "Disclosure status", 
        "開示状況");
    public static final TSE_T_CG DISCLOSURES_REQUIRED_BY_THE_PRINCIPLES_OF_THE_CORPORATE_GOVERNANCE_CODE = new TSE_T_CG(
    ...
    public static final TSE_T_CG DISCLOSURES_REQUIRED_BY_THE_PRINCIPLES_OF_THE_CORPORATE_GOVERNANCE_CODE_CHECK = new TSE_T_CG(
        "DisclosuresRequiredByThePrinciplesOfTheCorporateGovernanceCodeCheck", 
        "Disclosures required by the principles of the Corporate Governance Code", 
        "コーポレートガバナンス・コードの各原則に基づく開示");
    public static final TSE_T_CG EARLY_DISPATCH_OF_NOTICE_OF_SHAREHOLDERS_MEETING_ABSTRACT = new TSE_T_CG(
        "EarlyDispatchOfNoticeOfShareholdersMeetingAbstract", 
        "Early dispatch of notice of shareholders' meeting", 
        "株主総会招集通知の早期発送");
    public static final TSE_T_CG EARNINGS_DIGEST = new TSE_T_CG(
        "EarningsDigest", 
        "Earnings Digest", 
        "決算短信");
    public static final TSE_T_CG ELECTION_OF_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ElectionOfOutsideDirectors", 
        "Election of outside directors", 
        "社外取締役の選任状況");
    public static final TSE_T_CG ELECTION_OF_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "ElectionOfOutsideDirectorsCheck", 
        "Election of outside directors", 
        "社外取締役の選任状況");
    public static final TSE_T_CG ELECTION_OR_NON_ELECTION_OF_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "ElectionOrNonElectionOfOutsideCorporateAuditors", 
        "Election or non-election of outside corporate auditors", 
        "社外監査役の選任状況");
    public static final TSE_T_CG ELECTION_OR_NON_ELECTION_OF_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "ElectionOrNonElectionOfOutsideCorporateAuditorsCheck", 
        "Election or non-election of outside corporate auditors", 
        "社外監査役の選任状況");
    public static final TSE_T_CG ELECTRONIC_EXECUTION_OF_VOTING_RIGHTS_ABSTRACT = new TSE_T_CG(
        "ElectronicExecutionOfVotingRightsAbstract", 
        "Electronic execution of voting rights", 
        "電磁的方法による議決権の行使");
    public static final TSE_T_CG EMPLOYEES = new TSE_T_CG(
        "Employees", 
        "Employees", 
        "従業員");
    public static final TSE_T_CG EMPLOYEES_OF_PARENT_COMPANY = new TSE_T_CG(
        "EmployeesOfParentCompany", 
        "Employees of parent company", 
        "親会社の従業員");
    public static final TSE_T_CG EMPLOYEES_OF_SUBSIDIARIES = new TSE_T_CG(
        "EmployeesOfSubsidiaries", 
        "Employees of subsidiaries", 
        "子会社の従業員");
    public static final TSE_T_CG EMPLOYMENT_TERMS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
    ...
    public static final TSE_T_CG ESTABLISHMENT_OF_POLICY_CONCERNING_DISCLOSURE_OF_INFORMATION_TO_STAKEHOLDERS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG ESTABLISHMENT_OR_NON_ESTABLISHMENT_OF_ABOARD_OF_CORPORATE_AUDITORS = new TSE_T_CG(
        ...
        "監査役会の設置の有無");
    public static final TSE_T_CG ESTABLISHMENT_OR_NONESTABLISHMENT_OF_ABOARD_OF_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "EstablishmentOrNonestablishmentOfABoardOfCorporateAuditorsCheck", 
        "Establishment or non-establishment of a board of corporate auditors", 
        "監査役会の設置の有無");
    public static final TSE_T_CG EXECUTIVE_OFFICER_COMPENSATION_DISCLOSURE_STATUS = new TSE_T_CG(
        "ExecutiveOfficerCompensationDisclosureStatus", 
        "Executive officer compensation disclosure status", 
        "執行役報酬の開示状況");
    public static final TSE_T_CG EXECUTIVE_OFFICER_COMPENSATION_DISCLOSURE_STATUS_CHECK = new TSE_T_CG(
        "ExecutiveOfficerCompensationDisclosureStatusCheck", 
        "Executive officer compensation disclosure status", 
        "執行役報酬の開示状況");
    public static final TSE_T_CG EXECUTIVE_OFFICERS = new TSE_T_CG(
        "ExecutiveOfficers", 
        "Executive officers", 
        "執行役");
    public static final TSE_T_CG EXECUTIVE_OFFICERS_ABSTRACT = new TSE_T_CG(
        "ExecutiveOfficersAbstract", 
        "Executive officers", 
        "執行役関係");
    public static final TSE_T_CG EXECUTIVE_OFFICERS_OF_PARENT_COMPANY = new TSE_T_CG(
        "ExecutiveOfficersOfParentCompany", 
        "Executive officers of parent company", 
        "親会社の執行役");
    public static final TSE_T_CG EXECUTIVE_OFFICERS_OF_SUBSIDIARIES = new TSE_T_CG(
        "ExecutiveOfficersOfSubsidiaries", 
        "Executive officers of subsidiaries", 
        "子会社の執行役");
    public static final TSE_T_CG EXISTANCE_OF_PARENT_COMPANY = new TSE_T_CG(
        "ExistanceOfParentCompany", 
        "Existance of parent company", 
        "親会社の有無");
    public static final TSE_T_CG EXISTANCE_OF_PARENT_COMPANY_CHECK = new TSE_T_CG(
        "ExistanceOfParentCompanyCheck", 
        "Existance of parent company", 
        "親会社の有無");
    public static final TSE_T_CG EXISTENCE_OF_ACONTROLLING_SHAREHOLDERS = new TSE_T_CG(
        "ExistenceOfAControllingShareholders", 
        "Existence of a controlling shareholder(s)", 
        "支配株主（親会社を除く）の有無");
    public static final TSE_T_CG EXISTENCE_OF_ACONTROLLING_SHAREHOLDERS_CHECK = new TSE_T_CG(
        "ExistenceOfAControllingShareholdersCheck", 
        "Existence of a controlling shareholder(s)", 
        "支配株主（親会社を除く）の有無");
    public static final TSE_T_CG EXISTENCE_OF_COMMITTEES_VOLUNTARILY_ESTABLISHED_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG EXISTENCE_OF_COMMITTEES_VOLUNTARILY_ESTABLISHED_COMPOSITION_AND_ATTRIBUTES_OF_CHAIR_CHECK = new TSE_T_CG(
        "ExistenceOfCommitteesVoluntarilyEstablishedCompositionAndAttributesOfChairCheck", 
        "Existence of committees voluntarily established, composition and attributes of chair", 
        "任意の委員会の設置状況、委員構成、委員長（議長）の属性");
    public static final TSE_T_CG EXISTENCE_OF_METHODS_TO_DETERMINE_COMPENSATION_OR_COMPENSATION_POLICIES = new TSE_T_CG(
    ...
    public static final TSE_T_CG EXISTENCE_OF_METHODS_TO_DETERMINE_COMPENSATION_OR_COMPENSATION_POLICIES_CHECK = new TSE_T_CG(
        "ExistenceOfMethodsToDetermineCompensationOrCompensationPoliciesCheck", 
        "Existence of methods to determine compensation or compensation policies", 
        "報酬の額又はその算定方法の決定方針の有無");
    public static final TSE_T_CG EXPLANATION_BY_REPRESENTATIVE_MEMBERS_OF_THE_BOARD_ANALYSTS_AND_INSTITUTIONAL_INVESTORS = new TSE_T_CG(
        ...
        "代表者自身による説明の有無");
    public static final TSE_T_CG EXPLANATION_BY_REPRESENTATIVE_MEMBERS_OF_THE_BOARD_FOREIGN_INVESTORS = new TSE_T_CG(
        "ExplanationByRepresentativeMembersOfTheBoardForeignInvestors", 
        "Explanation by representative members of the board", 
        "代表者自身による説明の有無");
    public static final TSE_T_CG EXPLANATION_BY_REPRESENTATIVE_MEMBERS_OF_THE_BOARD_INDIVIDUAL_INVESTORS = new TSE_T_CG(
        "ExplanationByRepresentativeMembersOfTheBoardIndividualInvestors", 
        "Explanation by representative members of the board", 
        "代表者自身による説明の有無");
    public static final TSE_T_CG EXPLANATION_BY_REPRESENTATIVE_MEMBERS_OF_THE_BOARD_WEBSITE = new TSE_T_CG(
        "ExplanationByRepresentativeMembersOfTheBoardWebsite", 
        "Explanation by representative members of the board", 
        "代表者自身による説明の有無");
    public static final TSE_T_CG FINAL_UPDATE = new TSE_T_CG(
        "FinalUpdate", 
        "Final update", 
        "最終更新日");
    public static final TSE_T_CG FISCAL_YEAR_END = new TSE_T_CG(
        "FiscalYearEnd", 
        "Fiscal year end", 
        "決算期");
    public static final TSE_T_CG FISCAL_YEAR_END_CHECK = new TSE_T_CG(
        "FiscalYearEndCheck", 
        "Fiscal year end", 
        "決算期");
    public static final TSE_T_CG FUKUOKA = new TSE_T_CG(
        "Fukuoka", 
        "Fukuoka", 
        "福岡 既存市場");
    public static final TSE_T_CG FUKUOKA_QBOARD = new TSE_T_CG(
        "FukuokaQBoard", 
        "Fukuoka Q-Board", 
        "福岡 Q-Board");
    public static final TSE_T_CG FUKUOKA_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "FukuokaStockExchangeParentCompany", 
        "Fukuoka", 
        "福岡");
    public static final TSE_T_CG FUKUOKA_TO_BE_LISTED = new TSE_T_CG(
        "FukuokaToBeListed", 
        "Fukuoka  (to be listed)", 
        "福岡 （未定）");
    public static final TSE_T_CG GRANTEES_OF_STOCK_OPTIONS_ABSTRACT = new TSE_T_CG(
        "GranteesOfStockOptionsAbstract", 
        "Grantees of stock options", 
        "ストックオプションの付与対象者");
    public static final TSE_T_CG GRANTEES_OF_STOCK_OPTIONS_CHECK = new TSE_T_CG(
        "GranteesOfStockOptionsCheck", 
        "Grantees of stock options", 
        "ストックオプションの付与対象者");
    public static final TSE_T_CG GUIDELINES_RELATED_TO_PROTECTION_OF_NONCONTROLLING_SHAREHOLDERS_AT_TRADING_WITH_CONTROLLING_SHAREHOLDERS = new TSE_T_CG(
    ...
    public static final TSE_T_CG GUIDELINES_RELATED_TO_PROTECTION_OF_NONCONTROLLING_SHAREHOLDERS_AT_TRADING_WITH_CONTROLLING_SHAREHOLDERS_CHECK = new TSE_T_CG(
        "GuidelinesRelatedToProtectionOfNoncontrollingShareholdersAtTradingWithControllingShareholdersCheck", 
        "Guidelines related to protection of noncontrolling shareholders at trading with controlling shareholders", 
        "支配株主との取引等を行う際における少数株主の保護の方策に関する指針");
    public static final TSE_T_CG HOLDS_OFFICE_AS_MANAGEMENT_DIRECTOR_OR_EXECUTIVE_OFFICER_ETC_OF_ANOTHER_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG HOLDS_OFFICE_AS_MANAGEMENT_DIRECTOR_OR_EXECUTIVE_OFFICER_ETC_OF_ANOTHER_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "HoldsOfficeAsManagementDirectorOrExecutiveOfficerEtcOfAnotherCompanyOutsideDirectors", 
        "Holds office as management director or executive officer, etc. of another company", 
        "他の会社の業務執行取締役、執行役等である");
    public static final TSE_T_CG IRACTIVITIES_ABSTRACT = new TSE_T_CG(
        "IRActivitiesAbstract", 
        "IR activities", 
        "ＩＲに関する活動状況");
    public static final TSE_T_CG IRACTIVITIES_CHECK = new TSE_T_CG(
        "IRActivitiesCheck", 
        "IR activities", 
        "ＩＲに関する活動状況");
    public static final TSE_T_CG IRRELATED_DIVISIONS_PERSONNEL_ABSTRACT = new TSE_T_CG(
        "IRRelatedDivisionsPersonnelAbstract", 
        "IR related divisions (personnel)", 
        "IRに関する部署（担当者）の設置");
    public static final TSE_T_CG IMPLEMENTATION_OF_MEASURES_FOR_SHAREHOLDERS_AND_OTHER_STAKEHOLDERS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG IMPLEMENTATION_OF_MEASURES_ON_INCENTIVE_ALLOTMENT_TO_DIRECTORS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG IMPLEMENTATION_OF_MEASURES_ON_INCENTIVE_ALLOTMENT_TO_DIRECTORS_CHECK = new TSE_T_CG(
        "ImplementationOfMeasuresOnIncentiveAllotmentToDirectorsCheck", 
        "Implementation of measures on incentive allotment to directors", 
        "取締役へのインセンティブ付与に関する施策の実施状況");
    public static final TSE_T_CG INCENTIVES_ABSTRACT = new TSE_T_CG(
        "IncentivesAbstract", 
        "Incentives", 
        "インセンティブ関係");
    public static final TSE_T_CG INDEPENDENCE_OF_SAID_DIRECTORS_AND_EMPLOYEES_FROM_EXECUTIVE_OFFICERS = new TSE_T_CG(
    ...
    public static final TSE_T_CG INDEPENDENT_DIRECTORS_AUDITORS_ABSTRACT = new TSE_T_CG(
        "IndependentDirectorsAuditorsAbstract", 
        "independent directors / auditors", 
        "独立役員関係");
    public static final TSE_T_CG INDEPENDENT_DIRECTORS_AUDITORS_CHECK = new TSE_T_CG(
        "IndependentDirectorsAuditorsCheck", 
        "Independent directors / auditors", 
        "独立役員");
    public static final TSE_T_CG INDEPENDENT_DIRECTORS_AUDITORS_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "IndependentDirectorsAuditorsOutsideCorporateAuditors", 
        "Independent directors / auditors", 
        "独立役員");
    public static final TSE_T_CG INDEPENDENT_DIRECTORS_AUDITORS_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "IndependentDirectorsAuditorsOutsideDirectors", 
        "Independent directors / auditors", 
        "独立役員");
    public static final TSE_T_CG INDIVIDUAL_COMMITTEES_ABSTRACT = new TSE_T_CG(
        "IndividualCommitteesAbstract", 
        "Individual committees", 
        "各種委員会");
    public static final TSE_T_CG INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK = new TSE_T_CG(
        "InformationOnRetiredPresidentsOrCEOsHoldingAdvisoryPositionsCheck", 
        "Information on retired presidents/CEOs holding advisory positions (sodanyaku, komon, etc.)", 
        "元代表取締役社長等である相談役・顧問等の氏名等");
    public static final TSE_T_CG INFORMATION_ON_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_INCLUDED_OR_OMITTED = new TSE_T_CG(
        "InformationOnRetiredPresidentsOrCEOsHoldingAdvisoryPositionsIncludedOrOmitted", 
        "Information on retired presidents/CEOs holding advisory positions (sodanyaku, komon, etc.)", 
        "代表取締役社長等を退任した者の状況の記載の有無");
    public static final TSE_T_CG INSIDE_DIRECTORS = new TSE_T_CG(
        "InsideDirectors", 
        "Inside directors", 
        "社内取締役");
    public static final TSE_T_CG INTERNAL_AUDITORS = new TSE_T_CG(
        "InternalAuditors", 
        "Internal auditors", 
        "社内監査役");
    public static final TSE_T_CG INTRODUCING_TAKEOVER_DEFENSE_MEASURES = new TSE_T_CG(
        "IntroducingTakeoverDefenseMeasures", 
        "Introducing takeover defense measures", 
        "買収防衛策の導入の有無");
    public static final TSE_T_CG INTRODUCING_TAKEOVER_DEFENSE_MEASURES_ABSTRACT = new TSE_T_CG(
        "IntroducingTakeoverDefenseMeasuresAbstract", 
        "Introducing takeover defense measures", 
        "買収防衛策の導入の有無");
    public static final TSE_T_CG INTRODUCING_TAKEOVER_DEFENSE_MEASURES_CHECK = new TSE_T_CG(
        "IntroducingTakeoverDefenseMeasuresCheck", 
        "Introducing takeover defense measures", 
        "買収防衛策の導入の有無");
    public static final TSE_T_CG JASDAQ = new TSE_T_CG(
        "JASDAQ", 
        "JASDAQ", 
        "ジャスダック 既存市場");
    public static final TSE_T_CG JASDAQNEO = new TSE_T_CG(
        "JASDAQNEO", 
        "JASDAQ NEO", 
        "ジャスダック NEO");
    public static final TSE_T_CG JASDAQSTOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "JASDAQStockExchangeParentCompany", 
        "JASDAQ", 
        "ジャスダック");
    public static final TSE_T_CG JASDAQTO_BE_LISTED = new TSE_T_CG(
        "JASDAQToBeListed", 
        "JASDAQ  (to be listed)", 
        "ジャスダック （未定）");
    public static final TSE_T_CG JAPAN_SECURITIES_DEALERS_ASSOCIATION = new TSE_T_CG(
        "JapanSecuritiesDealersAssociation", 
        "Japan Securities Dealers Association", 
        "グリーンシート等");
    public static final TSE_T_CG JAPAN_SECURITIES_DEALERS_ASSOCIATION_PARENT_COMPANY = new TSE_T_CG(
        "JapanSecuritiesDealersAssociationParentCompany", 
        "Japan Securities Dealers Association", 
        "グリーンシート等");
    public static final TSE_T_CG JOB_TITLE_OR_POSITION_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        "JobTitleOrPositionRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Job title/position", 
        "役職・地位");
    public static final TSE_T_CG LIMITATION_OF_LIABILITY_AGREEMENT_IS_EXECUTED_BETWEEN_THE_SAID_PERSON_AND_THE_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG LIMITATION_OF_LIABILITY_AGREEMENT_IS_EXECUTED_BETWEEN_THE_SAID_PERSON_AND_THE_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "LimitationOfLiabilityAgreementIsExecutedBetweenTheSaidPersonAndTheCompanyOutsideDirectors", 
        "Limitation of liability agreement is executed between the said person and the company", 
        "本人と当該会社との間で責任限定契約を締結している");
    public static final TSE_T_CG MAJOR_SHAREHOLDER_OF_THE_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "MajorShareholderOfTheCompanyOutsideCorporateAuditors", 
        "Major shareholder of the company", 
        "当該会社の大株主である");
    public static final TSE_T_CG MAJOR_SHAREHOLDER_OF_THE_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "MajorShareholderOfTheCompanyOutsideDirectors", 
        "Major shareholder of the company", 
        "当該会社の大株主である");
    public static final TSE_T_CG MATTERS_PERTAINING_TO_FUNCTIONS_RELATING_TO_THE_EXECUTION_OF_DUTIES_AUDIT_AND_SUPERVISION_APPOINTMENT_AND_DECISIONS_REGARDING_COMPENSATION_ETC = new TSE_T_CG(
    ...
    public static final TSE_T_CG MATTERS_PERTAINING_TO_FUNCTIONS_RELATING_TO_THE_EXECUTION_OF_DUTIES_AUDIT_AND_SUPERVISION_APPOINTMENT_AND_DECISIONS_REGARDING_COMPENSATION_ETC_CHECK = new TSE_T_CG(
        ...
        "Matters pertaining to functions relating to the execution of duties, audit and supervision, appointment and decisions regarding compensation, etc (overview of the current corporate governance system)", 
        "業務執行、監査・監督、指名、報酬決定等の機能に係る事項（現状のコーポレート・ガバナンス体制の概要）");
    public static final TSE_T_CG MATTERS_REGARDING_DEFENSE_AGAINST_ATAKEOVER_BID = new TSE_T_CG(
        "MattersRegardingDefenseAgainstATakeoverBid", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG MATTERS_REGARDING_DEFENSE_AGAINST_ATAKEOVER_BID_CHECK = new TSE_T_CG(
        "MattersRegardingDefenseAgainstATakeoverBidCheck", 
        "Matters regarding defense against a takeover bid", 
        "買収防衛に関する事項");
    public static final TSE_T_CG MATTERS_REGARDING_INTERNAL_CONTROL_SYSTEM_ABSTRACT = new TSE_T_CG(
        "MattersRegardingInternalControlSystemAbstract", 
        "Matters regarding internal control system", 
        "内部統制システム等に関する事項");
    public static final TSE_T_CG MATTERS_REGARDING_OTHER_CORPORATE_GOVERNANCE_SYSTEMS_ETC = new TSE_T_CG(
        "MattersRegardingOtherCorporateGovernanceSystemsEtc", 
        "Matters regarding other corporate governance systems, etc", 
        "その他コーポレート・ガバナンス体制等に関する事項");
    public static final TSE_T_CG MATTERS_REGARDING_OTHER_CORPORATE_GOVERNANCE_SYSTEMS_ETC_CHECK = new TSE_T_CG(
        "MattersRegardingOtherCorporateGovernanceSystemsEtcCheck", 
        "Matters regarding other corporate governance systems, etc", 
        "その他コーポレート・ガバナンス体制等に関する事項");
    public static final TSE_T_CG MATTERS_RELATING_TO_OTHER_MAJOR_ACTIVITIES_OF_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        ...
        "その他社外監査役の主な活動に関する事項");
    public static final TSE_T_CG MATTERS_RELATING_TO_OTHER_MAJOR_ACTIVITIES_OF_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "MattersRelatingToOtherMajorActivitiesOfOutsideCorporateAuditorsCheck", 
        "Matters relating to other major activities of outside corporate auditors", 
        "その他社外監査役の主な活動に関する事項");
    public static final TSE_T_CG MATTERS_RELATING_TO_OTHER_MAJOR_ACTIVITIES_OF_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "MattersRelatingToOtherMajorActivitiesOfOutsideDirectors", 
        "Matters relating to other major activities of outside directors", 
        "その他社外取締役の主な活動に関する事項");
    public static final TSE_T_CG MATTERS_RELATING_TO_OTHER_MAJOR_ACTIVITIES_OF_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "MattersRelatingToOtherMajorActivitiesOfOutsideDirectorsCheck", 
        "Matters relating to other major activities of outside directors", 
        "その他社外取締役の主な活動に関する事項");
    public static final TSE_T_CG MEANS_OF_DISCLOSURE_ABSTRACT = new TSE_T_CG(
        "MeansOfDisclosureAbstract", 
        "Means of disclosure", 
        "開示手段");
    public static final TSE_T_CG MEANS_OF_DISCLOSURE_CHECK = new TSE_T_CG(
        "MeansOfDisclosureCheck", 
        "Means of disclosure", 
        "開示手段");
    public static final TSE_T_CG MEMBERSHIP_OF_COMMITTEES_OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "MembershipOfCommitteesOutsideDirectorsAbstract", 
        "Membership of committees", 
        "所属委員会");
    public static final TSE_T_CG NAGOYA_1ST_SECTION = new TSE_T_CG(
        "Nagoya1stSection", 
        "Nagoya 1st section", 
        "名古屋 第一部");
    public static final TSE_T_CG NAGOYA_2ND_SECTION = new TSE_T_CG(
        "Nagoya2ndSection", 
        "Nagoya 2nd section", 
        "名古屋 第二部");
    public static final TSE_T_CG NAGOYA_CENTREX = new TSE_T_CG(
        "NagoyaCentrex", 
        "Nagoya Centrex", 
        "名古屋 セントレックス");
    public static final TSE_T_CG NAGOYA_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "NagoyaStockExchangeParentCompany", 
        "Nagoya", 
        "名古屋");
    public static final TSE_T_CG NAGOYA_TO_BE_LISTED = new TSE_T_CG(
        "NagoyaToBeListed", 
        "Nagoya  (to be listed)", 
        "名古屋 （未定）");
    public static final TSE_T_CG NAME_EXECUTIVE_OFFICERS = new TSE_T_CG(
        "NameExecutiveOfficers", 
        "Name", 
        "氏名");
    public static final TSE_T_CG NAME_OF_COMMITTEE_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NameOfCommitteeCommitteeCorrespondingToCompensationCommittee", 
        "Name of committee", 
        "委員会の名称");
    public static final TSE_T_CG NAME_OF_COMMITTEE_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NameOfCommitteeCommitteeCorrespondingToNominatingCommittee", 
        "Name of committee", 
        "委員会の名称");
    public static final TSE_T_CG NAME_OF_SHAREHOLDERS = new TSE_T_CG(
        "NameOfShareholders", 
        "Name of shareholders", 
        "氏名又は名称");
    public static final TSE_T_CG NAME_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "NameOutsideCorporateAuditors", 
        "Name", 
        "氏名");
    public static final TSE_T_CG NAME_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NameOutsideDirectors", 
        "Name", 
        "氏名");
    public static final TSE_T_CG NAME_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        "NameRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Name", 
        "氏名");
    public static final TSE_T_CG NET_SALES_CONSOLIDATED = new TSE_T_CG(
        "NetSalesConsolidated", 
        "Net sales (consolidated)", 
        "直前事業年度における（連結）売上高");
    public static final TSE_T_CG NET_SALES_CONSOLIDATED_CHECK = new TSE_T_CG(
        "NetSalesConsolidatedCheck", 
        "Net sales (consolidated)", 
        "直前事業年度における（連結）売上高");
    public static final TSE_T_CG NOMINATION_COMMITTEE_ABSTRACT = new TSE_T_CG(
        "NominationCommitteeAbstract", 
        "Nomination committee", 
        "指名委員会");
    public static final TSE_T_CG NOMINATION_COMMITTEE_MEMBER = new TSE_T_CG(
        "NominationCommitteeMember", 
        "Nomination committee member", 
        "指名委員");
    public static final TSE_T_CG NOMINATION_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NominationCommitteeOutsideDirectors", 
        "Nomination committee", 
        "指名委員会");
    public static final TSE_T_CG NOT_ACTED_IRABSTRACT = new TSE_T_CG(
        "NotActedIRAbstract", 
        "Not acted", 
        "実施していません");
    public static final TSE_T_CG NOT_ACTED_STAKEHOLDERS_ABSTRACT = new TSE_T_CG(
        "NotActedStakeholdersAbstract", 
        "Not acted", 
        "実施していません");
    public static final TSE_T_CG NOT_IMPLEMENTED_SHAREHOLDERS_MEETING_ABSTRACT = new TSE_T_CG(
        "NotImplementedShareholdersMeetingAbstract", 
        "Not implemented", 
        "実施していません");
    public static final TSE_T_CG NOT_INCENTIVES = new TSE_T_CG(
        "NotIncentives", 
        "Not", 
        "実施していない");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_AUDIT = new TSE_T_CG(
        "NumberOfAllMembersAudit", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NumberOfAllMembersAuditEtcCommitteeOutsideDirectors", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfAllMembersCommitteeCorrespondingToCompensationCommittee", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfAllMembersCommitteeCorrespondingToNominatingCommittee", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_COMPENSATION = new TSE_T_CG(
        "NumberOfAllMembersCompensation", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_ALL_MEMBERS_NOMINATION = new TSE_T_CG(
        "NumberOfAllMembersNomination", 
        "Number of all members", 
        "全委員（名）");
    public static final TSE_T_CG NUMBER_OF_CONSOLIDATED_SUBSIDIARIES = new TSE_T_CG(
        "NumberOfConsolidatedSubsidiaries", 
        "Number of consolidated subsidiaries at the most current end of fiscal year", 
        "直前事業年度末における連結子会社数");
    public static final TSE_T_CG NUMBER_OF_CONSOLIDATED_SUBSIDIARIES_CHECK = new TSE_T_CG(
        "NumberOfConsolidatedSubsidiariesCheck", 
        "Number of consolidated subsidiaries at the most current end of fiscal year", 
        "直前事業年度末における連結子会社数");
    public static final TSE_T_CG NUMBER_OF_CORPORATE_AUDITORS = new TSE_T_CG(
        "NumberOfCorporateAuditors", 
        "Number of corporate auditors", 
        "監査役の人数");
    public static final TSE_T_CG NUMBER_OF_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "NumberOfCorporateAuditorsCheck", 
        "Number of corporate auditors", 
        "監査役の人数");
    public static final TSE_T_CG NUMBER_OF_DIRECTORS = new TSE_T_CG(
        "NumberOfDirectors", 
        "Number of directors", 
        "取締役の人数");
    public static final TSE_T_CG NUMBER_OF_DIRECTORS_CHECK = new TSE_T_CG(
        "NumberOfDirectorsCheck", 
        "Number of directors", 
        "取締役の人数");
    public static final TSE_T_CG NUMBER_OF_DIRECTORS_STIPULATED_IN_ARTICLES_OF_INCORPORATION = new TSE_T_CG(
        "NumberOfDirectorsStipulatedInArticlesOfIncorporation", 
        "Number of directors stipulated in articles of incorporation", 
        "定款上の取締役の員数");
    public static final TSE_T_CG NUMBER_OF_DIRECTORS_STIPULATED_IN_ARTICLES_OF_INCORPORATION_CHECK = new TSE_T_CG(
        "NumberOfDirectorsStipulatedInArticlesOfIncorporationCheck", 
        "Number of directors stipulated in articles of incorporation", 
        "定款上の取締役の員数");
    public static final TSE_T_CG NUMBER_OF_EMPLOYEES_CONSOLIDATED = new TSE_T_CG(
        "NumberOfEmployeesConsolidated", 
        "Number of employees at the most current end of fiscal year (consolidated)", 
        "直前事業年度末における（連結）従業員数");
    public static final TSE_T_CG NUMBER_OF_EMPLOYEES_CONSOLIDATED_CHECK = new TSE_T_CG(
        "NumberOfEmployeesConsolidatedCheck", 
        "Number of employees at the most current end of fiscal year (consolidated)", 
        "直前事業年度末における（連結）従業員数");
    public static final TSE_T_CG NUMBER_OF_EXECUTIVE_OFFICERS = new TSE_T_CG(
        "NumberOfExecutiveOfficers", 
        "Number of executive officers", 
        "執行役の人数");
    public static final TSE_T_CG NUMBER_OF_EXECUTIVE_OFFICERS_CHECK = new TSE_T_CG(
        "NumberOfExecutiveOfficersCheck", 
        "Number of executive officers", 
        "執行役の人数");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_AUDIT = new TSE_T_CG(
        "NumberOfFullTimeMembersAudit", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NumberOfFullTimeMembersAuditEtcCommitteeOutsideDirectors", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfFullTimeMembersCommitteeCorrespondingToCompensationCommittee", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfFullTimeMembersCommitteeCorrespondingToNominatingCommittee", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_COMPENSATION = new TSE_T_CG(
        "NumberOfFullTimeMembersCompensation", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_FULL_TIME_MEMBERS_NOMINATION = new TSE_T_CG(
        "NumberOfFullTimeMembersNomination", 
        "Number of full-time members", 
        "常勤委員（名）");
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_AUDITORS_OUT_OF_OUTSIDE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_AUDITORS_OUT_OF_OUTSIDE_AUDITORS_CHECK = new TSE_T_CG(
        "NumberOfIndependentAuditorsOutOfOutsideAuditorsCheck", 
        "Number of independent auditors out of outside auditors", 
        "社外監査役のうち独立役員に指定されている人数");
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_DIRECTORS_AUDITORS = new TSE_T_CG(
        "NumberOfIndependentDirectorsAuditors", 
        "Number of independent directors / auditors", 
        "独立役員の人数");
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_DIRECTORS_AUDITORS_CHECK = new TSE_T_CG(
        "NumberOfIndependentDirectorsAuditorsCheck", 
        "Number of independent directors / auditors", 
        "独立役員の人数");
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_DIRECTORS_OUT_OF_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG NUMBER_OF_INDEPENDENT_DIRECTORS_OUT_OF_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "NumberOfIndependentDirectorsOutOfOutsideDirectorsCheck", 
        "Number of independent directors out of outside directors", 
        "社外取締役のうち独立役員に指定されている人数");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_AUDIT = new TSE_T_CG(
        "NumberOfInsideDirectorsAudit", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NumberOfInsideDirectorsAuditEtcCommitteeOutsideDirectors", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfInsideDirectorsCommitteeCorrespondingToCompensationCommittee", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfInsideDirectorsCommitteeCorrespondingToNominatingCommittee", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_COMPENSATION = new TSE_T_CG(
        "NumberOfInsideDirectorsCompensation", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_INSIDE_DIRECTORS_NOMINATION = new TSE_T_CG(
        "NumberOfInsideDirectorsNomination", 
        "Number of inside directors", 
        "社内取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OTHERS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfOthersCommitteeCorrespondingToCompensationCommittee", 
        "Number of others", 
        "その他（名）");
    public static final TSE_T_CG NUMBER_OF_OTHERS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfOthersCommitteeCorrespondingToNominatingCommittee", 
        "Number of others", 
        "その他（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "NumberOfOutsideCorporateAuditors", 
        "Number of outside corporate auditors", 
        "社外監査役の人数");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "NumberOfOutsideCorporateAuditorsCheck", 
        "Number of outside corporate auditors", 
        "社外監査役の人数");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NumberOfOutsideDirectors", 
        "Number of outside directors", 
        "社外取締役の人数");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_AUDIT = new TSE_T_CG(
        "NumberOfOutsideDirectorsAudit", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_AUDIT_ETC_COMMITTEE_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "NumberOfOutsideDirectorsAuditEtcCommitteeOutsideDirectors", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "NumberOfOutsideDirectorsCheck", 
        "Number of outside directors", 
        "社外取締役の人数");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfOutsideDirectorsCommitteeCorrespondingToCompensationCommittee", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfOutsideDirectorsCommitteeCorrespondingToNominatingCommittee", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_COMPENSATION = new TSE_T_CG(
        "NumberOfOutsideDirectorsCompensation", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_DIRECTORS_NOMINATION = new TSE_T_CG(
        "NumberOfOutsideDirectorsNomination", 
        "Number of outside directors", 
        "社外取締役（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_INTELLECTUALS_COMMITTEE_CORRESPONDING_TO_COMPENSATION_COMMITTEE = new TSE_T_CG(
        "NumberOfOutsideIntellectualsCommitteeCorrespondingToCompensationCommittee", 
        "Number of outside intellectuals", 
        "社外有識者（名）");
    public static final TSE_T_CG NUMBER_OF_OUTSIDE_INTELLECTUALS_COMMITTEE_CORRESPONDING_TO_NOMINATING_COMMITTEE = new TSE_T_CG(
        "NumberOfOutsideIntellectualsCommitteeCorrespondingToNominatingCommittee", 
        "Number of outside intellectuals", 
        "社外有識者（名）");
    public static final TSE_T_CG NUMBER_OF_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
    ...
    public static final TSE_T_CG NUMBER_OF_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK = new TSE_T_CG(
        "NumberOfRetiredPresidentsOrCEOsHoldingAdvisoryPositionsCheck", 
        "Number of retired presidents/CEOs holding advisory positions (sodanyaku, komon, etc.)", 
        "元代表取締役社長等である相談役・顧問等の合計人数");
    public static final TSE_T_CG NUMBER_OF_SHARES_HELD_SHARES = new TSE_T_CG(
        "NumberOfSharesHeldShares", 
        "Number of shares held (shares)", 
        "所有株式数（株）");
    public static final TSE_T_CG NUMBER_OF_STATUTORY_AUDITORS_STIPULATED_IN_ARTICLES_OF_INCORPORATION = new TSE_T_CG(
        ...
        "定款上の監査役の員数");
    public static final TSE_T_CG NUMBER_OF_STATUTORY_AUDITORS_STIPULATED_IN_ARTICLES_OF_INCORPORATION_CHECK = new TSE_T_CG(
        "NumberOfStatutoryAuditorsStipulatedInArticlesOfIncorporationCheck", 
        "Number of statutory auditors stipulated in articles of incorporation", 
        "定款上の監査役の員数");
    public static final TSE_T_CG ORGANIZATION_STRUCTURES_AND_ORGANIZATIONAL_OPERATIONS_ABSTRACT = new TSE_T_CG(
        "OrganizationStructuresAndOrganizationalOperationsAbstract", 
        "Organization structures and organizational operations", 
        "機関構成・組織運営等に係る事項");
    public static final TSE_T_CG ORGANIZATIONAL_FORM = new TSE_T_CG(
        "OrganizationalForm", 
        "Organizational form", 
        "組織形態");
    public static final TSE_T_CG ORGANIZATIONAL_FORM_20150401 = new TSE_T_CG(
        "OrganizationalForm20150401", 
        "Organizational form", 
        "組織形態");
    public static final TSE_T_CG OSAKA_1ST_SECTION = new TSE_T_CG(
        "Osaka1stSection", 
        "Osaka 1st section", 
        "大阪 第一部");
    public static final TSE_T_CG OSAKA_2ND_SECTION = new TSE_T_CG(
        "Osaka2ndSection", 
        "Osaka 2nd section", 
        "大阪 第二部");
    public static final TSE_T_CG OSAKA_HERCULES = new TSE_T_CG(
        "OsakaHercules", 
        "Osaka JASDAQ", 
        "大阪 JASDAQ");
    public static final TSE_T_CG OSAKA_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "OsakaStockExchangeParentCompany", 
        "Osaka", 
        "大阪");
    public static final TSE_T_CG OSAKA_TO_BE_LISTED = new TSE_T_CG(
        "OsakaToBeListed", 
        "Osaka (to be listed)", 
        "大阪 （未定）");
    public static final TSE_T_CG OTHER_GRANTEES_OF_STOCK_OPTIONS = new TSE_T_CG(
        "OtherGranteesOfStockOptions", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_IRABSTRACT = new TSE_T_CG(
        "OtherIRAbstract", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_INCENTIVES = new TSE_T_CG(
        "OtherIncentives", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_MEANS_OF_DISCLOSURE = new TSE_T_CG(
        "OtherMeansOfDisclosure", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_NOTES_REGARDING_INDEPENDENT_DIRECTORS_AUDITORS = new TSE_T_CG(
        "OtherNotesRegardingIndependentDirectorsAuditors", 
        "Other notes regarding independent directors / auditors", 
        "その他独立役員に関する事項");
    public static final TSE_T_CG OTHER_NOTES_REGARDING_INDEPENDENT_DIRECTORS_AUDITORS_CHECK = new TSE_T_CG(
        "OtherNotesRegardingIndependentDirectorsAuditorsCheck", 
        "Other notes regarding independent directors / auditors", 
        "その他独立役員に関する事項");
    public static final TSE_T_CG OTHER_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "OtherOutsideCorporateAuditors", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "OtherOutsideDirectors", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_PARTICULAR_CONDITIONS_THAT_MAY_MATERIALLY_AFFECT_CORPORATE_GOVERNANCE = new TSE_T_CG(
    ...
    public static final TSE_T_CG OTHER_PARTICULAR_CONDITIONS_THAT_MAY_MATERIALLY_AFFECT_CORPORATE_GOVERNANCE_CHECK = new TSE_T_CG(
        "OtherParticularConditionsThatMayMateriallyAffectCorporateGovernanceCheck", 
        "Other particular conditions that may materially affect corporate governance", 
        "その他コーポレート・ガバナンスに重要な影響を与えうる特別な事情");
    public static final TSE_T_CG OTHER_SHAREHOLDERS_MEETING_ABSTRACT = new TSE_T_CG(
        "OtherShareholdersMeetingAbstract", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHER_STAKEHOLDERS_ABSTRACT = new TSE_T_CG(
        "OtherStakeholdersAbstract", 
        "Other", 
        "その他");
    public static final TSE_T_CG OTHERS_ABSTRACT = new TSE_T_CG(
        "OthersAbstract", 
        "Others", 
        "その他");
    public static final TSE_T_CG OTHERS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        "OthersRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Others", 
        "その他の事項");
    public static final TSE_T_CG OTHERS_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_CHECK = new TSE_T_CG(
        "OthersRetiredPresidentsOrCEOsHoldingAdvisoryPositionsCheck", 
        "Others", 
        "その他の事項");
    public static final TSE_T_CG OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "OutsideCorporateAuditors", 
        "Outside corporate auditors", 
        "社外監査役");
    public static final TSE_T_CG OUTSIDE_DIRECTOR_SUPPORT_SYSTEM = new TSE_T_CG(
        "OutsideDirectorSupportSystem", 
        "Outside director support system", 
        "社外取締役のサポート体制");
    public static final TSE_T_CG OUTSIDE_DIRECTOR_SUPPORT_SYSTEM_CHECK = new TSE_T_CG(
        "OutsideDirectorSupportSystemCheck", 
        "Outside director support system", 
        "社外取締役のサポート体制");
    public static final TSE_T_CG OUTSIDE_DIRECTORS = new TSE_T_CG(
        "OutsideDirectors", 
        "Outside directors", 
        "社外取締役");
    public static final TSE_T_CG OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "OutsideDirectorsAbstract", 
        "Outside directors", 
        "社外取締役に関する事項");
    public static final TSE_T_CG OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "OutsideDirectorsCheck", 
        "Outside directors", 
        "社外取締役に関する事項");
    public static final TSE_T_CG OVERSEAS_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "OverseasStockExchangeParentCompany", 
        "Overseas", 
        "海外");
    public static final TSE_T_CG OWNERSHIP_INTEREST = new TSE_T_CG(
        "OwnershipInterest", 
        "Ownership interest (%)", 
        "割合（％）");
    public static final TSE_T_CG PARENT_COMPANY = new TSE_T_CG(
        "ParentCompany", 
        "Parent company", 
        "親会社名");
    public static final TSE_T_CG PARTICIPATION_IN_ELECTRONIC_VOTING_PLATFORMS_AND_OTHER_ACTIVITIES_TO_IMPROVE_VOTING_ENVIRONMENT_FOR_INSTITUTIONAL_INVESTORS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG PARTICIPATION_OF_ELECTRONIC_VOTING_PLATFORM_AND_OTHER_ACTIVITIES_TO_IMPROVE_VOTING_ENVIRONMENT_FOR_INSTITUTIONAL_INVESTORS = new TSE_T_CG(
        "ParticipationOfElectronicVotingPlatformAndOtherActivitiesToImproveVotingEnvironmentForInstitutionalInvestors", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG PERCENTAGE_OF_SHARES_HELD_BY_FOREIGN_INVESTORS = new TSE_T_CG(
        "PercentageOfSharesHeldByForeignInvestors", 
        "Percentage of shares held by foreign investors", 
        "外国人株式保有比率");
    public static final TSE_T_CG PERCENTAGE_OF_SHARES_HELD_BY_FOREIGN_INVESTORS_CHECK = new TSE_T_CG(
        "PercentageOfSharesHeldByForeignInvestorsCheck", 
        "Percentage of shares held by foreign investors", 
        "外国人株式保有比率");
    public static final TSE_T_CG PERFORMANCE_BASED_COMPENSATION_SYSTEM = new TSE_T_CG(
        "PerformanceBasedCompensationSystem", 
        "Performance-based compensation system", 
        "業績連動報酬制度の導入");
    public static final TSE_T_CG PROMOTION_OF_ENVIRONMENTAL_PRESERVATION_ACTIVITIES_AND_CSRACTIVITIES_ABSTRACT = new TSE_T_CG(
        ...
        "環境保全活動、ＣＳＲ活動等の実施");
    public static final TSE_T_CG PUBLIC_ANNOUNCEMENT_OF_DISCLOSURE_POLICY = new TSE_T_CG(
        "PublicAnnouncementOfDisclosurePolicy", 
        "Correspondence", 
        "該当");
    public static final TSE_T_CG PUBLIC_ANNOUNCEMENT_OF_DISCLOSURE_POLICY_ABSTRACT = new TSE_T_CG(
        "PublicAnnouncementOfDisclosurePolicyAbstract", 
        "Public announcement of disclosure policy", 
        "ディスクロージャーポリシーの作成・公表");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_CORPORATE_GOVERNANCE_SYSTEM = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentCorporateGovernanceSystem", 
        "Reason for adopting the current corporate governance system", 
        "現状のコーポレート・ガバナンス体制を選択している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_CORPORATE_GOVERNANCE_SYSTEM_CHECK = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentCorporateGovernanceSystemCheck", 
        "Reason for adopting the current corporate governance system", 
        "現状のコーポレート・ガバナンス体制を選択している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_SYSTEM_AUDITING_STRUCTURE = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentSystemAuditingStructure", 
        "Reason for adopting the current system", 
        "現在の体制を採用している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_SYSTEM_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentSystemOutsideCorporateAuditors", 
        "Reason for adopting the current system", 
        "現状の体制を採用している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_SYSTEM_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentSystemOutsideCorporateAuditorsCheck", 
        "Reason for adopting the current system", 
        "現状の体制を採用している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_SYSTEM_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentSystemOutsideDirectors", 
        "Reason for adopting the current system", 
        "現状の体制を採用している理由");
    public static final TSE_T_CG REASON_FOR_ADOPTING_THE_CURRENT_SYSTEM_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "ReasonForAdoptingTheCurrentSystemOutsideDirectorsCheck", 
        "Reason for adopting the current system", 
        "現状の体制を採用している理由");
    public static final TSE_T_CG REASON_FOR_ELECTION_AS_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "ReasonForElectionAsOutsideCorporateAuditors", 
        "Reasons for appointment", 
        "選任の理由");
    public static final TSE_T_CG REASON_FOR_ELECTION_AS_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "ReasonForElectionAsOutsideDirectors", 
        "Reasons for appointment", 
        "選任の理由");
    public static final TSE_T_CG REASONS_FOR_IMPLEMENTING_THE_FORMAT_OF_ACOMPANY_WITH_ACOMMITTEES_SYSTEM = new TSE_T_CG(
        ...
        "委員会設置会社形態を採用している理由");
    public static final TSE_T_CG REASONS_FOR_IMPLEMENTING_THE_FORMAT_OF_ACOMPANY_WITH_ACOMMITTEES_SYSTEM_CHECK = new TSE_T_CG(
        "ReasonsForImplementingTheFormatOfACompanyWithACommitteesSystemCheck", 
        "Reasons for implementing the format of a company with a committees system", 
        "委員会設置会社形態を採用している理由");
    public static final TSE_T_CG REASONS_FOR_NON_COMPLIANCE_WITH_THE_PRINCIPLES_OF_THE_CORPORATE_GOVERNANCE_CODE = new TSE_T_CG(
        "ReasonsForNon-complianceWithThePrinciplesOfTheCorporateGovernanceCode", 
        "Reasons for non-compliance with the principles of the Corporate Governance Code", 
        "コーポレートガバナンス・コードの各原則を実施しない理由");
    public static final TSE_T_CG REASONS_FOR_NON_COMPLIANCE_WITH_THE_PRINCIPLES_OF_THE_CORPORATE_GOVERNANCE_CODE_CHECK = new TSE_T_CG(
        "ReasonsForNon-complianceWithThePrinciplesOfTheCorporateGovernanceCodeCheck", 
        "Reasons for non-compliance with the principles of the Corporate Governance Code", 
        "コーポレートガバナンス・コードの各原則を実施しない理由");
    public static final TSE_T_CG RECEIVES_COMPENSATION_ETC_OR_OTHER_PROFITS_ON_ASSETS_FROM_THE_PARENT_COMPANY_OF_THE_COMPANY_OR_ASUBSIDIARY_OF_SUCH_PARENT_COMPANY_AS_AN_OFFICER_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RECEIVES_COMPENSATION_ETC_OR_OTHER_PROFITS_ON_ASSETS_FROM_THE_PARENT_COMPANY_OF_THE_COMPANY_OR_ASUBSIDIARY_OF_SUCH_PARENT_COMPANY_AS_AN_OFFICER_OUTSIDE_DIRECTORS = new TSE_T_CG(
        ...
        "Receives compensation, etc. or other profits on assets from the parent company of the company or a subsidiary of such parent company as an officer", 
        "当該会社の親会社又は当該親会社の子会社から役員としての報酬等その他の財産上の利益を受けている");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_10_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_10_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_11_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_11_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany11OutsideDirectors", 
        "Others", 
        "その他");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_12_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany12OutsideCorporateAuditors", 
        "Person who executes business for an entity receiving contributions from the company", 
        "上場会社が寄付を行っている先の業務執行者（本人のみ）");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_12_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany12OutsideDirectors", 
        "Relation with the company 12", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_13_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany13OutsideCorporateAuditors", 
        "Others", 
        "その他");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_13_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany13OutsideDirectors", 
        "Relation with the company 13", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_14_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany14OutsideCorporateAuditors", 
        "Relation with the company 14", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_14_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany14OutsideDirectors", 
        "Relation with the company 14", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_15_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany15OutsideCorporateAuditors", 
        "Relation with the company 15", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_15_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany15OutsideDirectors", 
        "Relation with the company 15", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_16_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany16OutsideCorporateAuditors", 
        "Relation with the company 16", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_16_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany16OutsideDirectors", 
        "Relation with the company 16", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_17_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany17OutsideCorporateAuditors", 
        "Relation with the company 17", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_17_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany17OutsideDirectors", 
        "Relation with the company 17", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_18_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany18OutsideCorporateAuditors", 
        "Relation with the company 18", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_18_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany18OutsideDirectors", 
        "Relation with the company 18", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_19_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany19OutsideCorporateAuditors", 
        "Relation with the company 19", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_19_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany19OutsideDirectors", 
        "Relation with the company 19", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany1OutsideCorporateAuditors", 
        "Person who executes business of the company or a subsidiary", 
        "上場会社又はその子会社の業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_CORPORATE_AUDITORS_20150401_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany1OutsideCorporateAuditors20150401Abstract", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_CORPORATE_AUDITORS_20150401_CHECK = new TSE_T_CG(
        "RelationWithTheCompany1OutsideCorporateAuditors20150401Check", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_CORPORATE_AUDITORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany1OutsideCorporateAuditorsAbstract", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "RelationWithTheCompany1OutsideCorporateAuditorsCheck", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany1OutsideDirectors", 
        "Person who executes business of the company or a subsidiary", 
        "上場会社又はその子会社の業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_DIRECTORS_20150401_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany1OutsideDirectors20150401Abstract", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_DIRECTORS_20150401_CHECK = new TSE_T_CG(
        "RelationWithTheCompany1OutsideDirectors20150401Check", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany1OutsideDirectorsAbstract", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_1_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "RelationWithTheCompany1OutsideDirectorsCheck", 
        "Relation with the company (1)", 
        "会社との関係(1)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_20_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany20OutsideCorporateAuditors", 
        "Relation with the company 20", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_20_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany20OutsideDirectors", 
        "Relation with the company 20", 
        "未使用");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_CORPORATE_AUDITORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany2OutsideCorporateAuditorsAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "RelationWithTheCompany2OutsideCorporateAuditorsCheck", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectors", 
        "Person who executes business or a non-executive director of a parent company", 
        "上場会社の親会社の業務執行者又は非業務執行取締役");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CAABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsCAAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CACHECK = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsCACheck", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CMABSTRACT = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsCMAbstract", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CMCHECK = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsCMCheck", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_2_OUTSIDE_DIRECTORS_CHECK = new TSE_T_CG(
        "RelationWithTheCompany2OutsideDirectorsCheck", 
        "Relation with the company (2)", 
        "会社との関係(2)");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_3_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany3OutsideCorporateAuditors", 
        "Person who executes business or a non-executive director of a parent company", 
        "上場会社の親会社の業務執行者又は非業務執行取締役");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_3_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany3OutsideDirectors", 
        "Person who executes business of a fellow subsidiary", 
        "上場会社の兄弟会社の業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_4_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany4OutsideCorporateAuditors", 
        "Auditor of a parent company", 
        "上場会社の親会社の監査役");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_4_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_5_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany5OutsideCorporateAuditors", 
        "Person who executes business of a fellow subsidiary", 
        "上場会社の兄弟会社の業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_5_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany5OutsideDirectors", 
        "Major client of the company or a person who executes business for such client", 
        "上場会社の主要な取引先又はその業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_6_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany6OutsideCorporateAuditors", 
        "Person/entity for which the company is a major client or a person who executes business for such person/entity", 
        "上場会社を主要な取引先とする者又はその業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_6_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_7_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany7OutsideCorporateAuditors", 
        "Major client of the company or a person who executes business for such client", 
        "上場会社の主要な取引先又はその業務執行者");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_7_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_8_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany8OutsideCorporateAuditors", 
        "Consultant, accounting expert, or legal expert who receives large amounts of cash or other assets in addition to director/auditor compensation from the company", 
        "上場会社から役員報酬以外に多額の金銭その他の財産を得ているコンサルタント、会計専門家、法律専門家");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_8_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_9_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "RelationWithTheCompany9OutsideCorporateAuditors", 
        "Major shareholder of the company (in cases where the shareholder is a corporation, a person who executes business of the corporation)", 
        "上場会社の主要株主（当該主要株主が法人である場合には、当該法人の業務執行者）");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_9_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "RelationWithTheCompany9OutsideDirectors", 
        "Person who executes business for another company holding cross-directorships/cross-auditorships with the company", 
        "社外役員の相互就任の関係にある先の業務執行者（本人のみ）");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_OUTSIDE_CORPORATE_AUDITORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompanyOutsideCorporateAuditorsAbstract", 
        "Relation with the company", 
        "会社との関係");
    public static final TSE_T_CG RELATION_WITH_THE_COMPANY_OUTSIDE_DIRECTORS_ABSTRACT = new TSE_T_CG(
        "RelationWithTheCompanyOutsideDirectorsAbstract", 
        "Relation with the company", 
        "会社との関係");
    public static final TSE_T_CG REPORTING_DATE = new TSE_T_CG(
        "ReportingDate", 
        "Reporting date", 
        "報告日");
    public static final TSE_T_CG REPRESENTATIVE_AUTHORITY = new TSE_T_CG(
        "RepresentativeAuthority", 
        "Representative authority", 
        "代表権の有無");
    public static final TSE_T_CG REPRESENTATIVE_STITLE_AND_NAME = new TSE_T_CG(
        "RepresentativeSTitleAndName", 
        "Representative's title and name", 
        "代表者役職氏名");
    public static final TSE_T_CG RESPONSIBILITIES_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        "ResponsibilitiesRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Responsibilities", 
        "業務内容");
    public static final TSE_T_CG RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS_ABSTRACT = new TSE_T_CG(
        ...
        "代表取締役社長等を退任した者の状況");
    public static final TSE_T_CG SAPPORO = new TSE_T_CG(
        "Sapporo", 
        "Sapporo", 
        "札幌 既存市場");
    public static final TSE_T_CG SAPPORO_AMBITIOUS = new TSE_T_CG(
        "SapporoAmbitious", 
        "Sapporo Ambitious", 
        "札幌 アンビシャス");
    public static final TSE_T_CG SAPPORO_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "SapporoStockExchangeParentCompany", 
        "Sapporo", 
        "札幌");
    public static final TSE_T_CG SAPPORO_TO_BE_LISTED = new TSE_T_CG(
        "SapporoToBeListed", 
        "Sapporo  (to be listed)", 
        "札幌 （未定）");
    public static final TSE_T_CG SCHEDULING_OF_SHAREHOLDERS_MEETING_AWAY_FROM_CONCENTRATED_DAYS_ABSTRACT = new TSE_T_CG(
        ...
        "集中日を回避した株主総会の設定");
    public static final TSE_T_CG SECTOR = new TSE_T_CG(
        "Sector", 
        "Sector", 
        "業種");
    public static final TSE_T_CG SECTOR_CHECK = new TSE_T_CG(
        "SectorCheck", 
        "Sector", 
        "業種");
    public static final TSE_T_CG SECURITIES_CODE = new TSE_T_CG(
        "SecuritiesCode", 
        "Securities code", 
        "証券コード");
    public static final TSE_T_CG SECURITIES_CODE_OF_PARENT_COMPANY = new TSE_T_CG(
        "SecuritiesCodeOfParentCompany", 
        "Securities code", 
        "コード（数字4桁）");
    public static final TSE_T_CG SETTING_FORTH_PROVISIONS_IN_THE_INTERNAL_REGULATIONS_CONCERNING_RESPECT_FOR_THE_STAKEHOLDERS_POSITION_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG SPECIAL_NOTE_FOR_DESCRIPTION_OF_MAJOR_SHAREHOLDERS = new TSE_T_CG(
        "SpecialNoteForDescriptionOfMajorShareholders", 
        "Special note for description of major shareholders", 
        "補足説明");
    public static final TSE_T_CG SPECIAL_NOTE_FOR_DESCRIPTION_OF_MAJOR_SHAREHOLDERS_CHECK = new TSE_T_CG(
        "SpecialNoteForDescriptionOfMajorShareholdersCheck", 
        "Special note for description of major shareholders", 
        "補足説明");
    public static final TSE_T_CG SPOUSE_RELATIVES_WITHIN_THIRD_DEGREE_OF_CONSANGUINITY_OR_AN_EQUIVALENT_PERSON_OF_MANAGEMENT_LEVEL_SUCH_AS_MANAGEMENT_DIRECTOR_OR_EXECUTIVE_OFFICER_ETC_OF_THE_COMPANY_OR_SPECIFIC_AFFILIATES_OF_THE_COMPANY_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG SPOUSE_RELATIVES_WITHIN_THIRD_DEGREE_OF_CONSANGUINITY_OR_AN_EQUIVALENT_PERSON_OF_MANAGEMENT_LEVEL_SUCH_AS_MANAGEMENT_DIRECTOR_OR_EXECUTIVE_OFFICER_ETC_OF_THE_COMPANY_OR_SPECIFIC_AFFILIATES_OF_THE_COMPANY_OUTSIDE_DIRECTORS = new TSE_T_CG(
    ...
    public static final TSE_T_CG STATUS_OF_ADDITIONAL_DUTIES_ABSTRACT = new TSE_T_CG(
        "StatusOfAdditionalDutiesAbstract", 
        "Status of additional duties", 
        "兼任状況");
    public static final TSE_T_CG STATUS_OF_ADDITIONAL_DUTIES_CHECK = new TSE_T_CG(
        "StatusOfAdditionalDutiesCheck", 
        "Status of additional duties", 
        "兼任状況");
    public static final TSE_T_CG STATUS_OF_IMPLEMENTATION_OF_MEASURES_FOR_REVITALIZATION_OF_THE_SHAREHOLDERS_MEETING_AND_SMOOTHING_OF_THE_EXECUTION_OF_VOTING_RIGHTS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG STATUS_OF_IMPLEMENTATION_OF_MEASURES_FOR_REVITALIZATION_OF_THE_SHAREHOLDERS_MEETING_AND_SMOOTHING_OF_THE_EXECUTION_OF_VOTING_RIGHTS_CHECK = new TSE_T_CG(
        "StatusOfImplementationOfMeasuresForRevitalizationOfTheShareholdersMeetingAndSmoothingOfTheExecutionOfVotingRightsCheck", 
        "Status of implementation of measures for revitalization of the shareholders' meeting and smoothing of the execution of voting rights", 
        "株主総会の活性化及び議決権行使の円滑化に向けての取組み状況");
    public static final TSE_T_CG STATUS_OF_THE_IMPLEMENTATION_OF_MEASURES_TO_GIVE_INCENTIVES_TO_DIRECTORS_AND_EXECUTIVE_OFFICERS_ABSTRACT = new TSE_T_CG(
    ...
    public static final TSE_T_CG STATUS_OF_THE_IMPLEMENTATION_OF_MEASURES_TO_GIVE_INCENTIVES_TO_DIRECTORS_AND_EXECUTIVE_OFFICERS_CHECK = new TSE_T_CG(
        "StatusOfTheImplementationOfMeasuresToGiveIncentivesToDirectorsAndExecutiveOfficersCheck", 
        "Status of the implementation of measures to give incentives to directors and executive officers", 
        "取締役・執行役へのインセンティブ付与に関する施策の実施状況");
    public static final TSE_T_CG STOCK_OPTION_SYSTEM = new TSE_T_CG(
        "StockOptionSystem", 
        "Stock option system", 
        "ストックオプション制度の導入");
    public static final TSE_T_CG STOCKEXCHANGE_ABSTRACT = new TSE_T_CG(
        "StockexchangeAbstract", 
        "Stock exchange", 
        "取引所");
    public static final TSE_T_CG STOCKEXCHANGE_AND_SECTION_CHECK = new TSE_T_CG(
        "StockexchangeAndSectionCheck", 
        "Stock exchange and section", 
        "上場取引所及び市場区分");
    public static final TSE_T_CG STOCKEXCHANGE_ANDSECTION_ABSTRACT = new TSE_T_CG(
        "StockexchangeAndsectionAbstract", 
        "Stock exchange and section", 
        "上場取引所及び市場区分");
    public static final TSE_T_CG STOCKEXCHANGE_LISTING = new TSE_T_CG(
        "StockexchangeListing", 
        "Stock exchange listing", 
        "上場区分");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_ANALYSTS_AND_INSTITUTIONAL_INVESTORS = new TSE_T_CG(
        "SupplementaryInformationAnalystsAndInstitutionalInvestors", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_AVAILABILITY_OF_ENGLISH_TRANSLATION_OF_GENERAL_SHAREHOLDERS_MEETING_NOTICE = new TSE_T_CG(
        "SupplementaryInformationAvailabilityOfEnglishTranslationOfGeneralShareholdersMeetingNotice", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_CSR = new TSE_T_CG(
        "SupplementaryInformationCSR", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_CONCENTRATED_DAYS = new TSE_T_CG(
        "SupplementaryInformationConcentratedDays", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DEFENSE_AGAINST_ATAKEOVER_BID = new TSE_T_CG(
        "SupplementaryInformationDefenseAgainstATakeoverBid", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DEFENSE_AGAINST_ATAKEOVER_BID_CHECK = new TSE_T_CG(
        "SupplementaryInformationDefenseAgainstATakeoverBidCheck", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DIRECTORS = new TSE_T_CG(
        "SupplementaryInformationDirectors", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DIRECTORS_CHECK = new TSE_T_CG(
        "SupplementaryInformationDirectorsCheck", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DISCLOSURE_OF_INFORMATION = new TSE_T_CG(
        "SupplementaryInformationDisclosureOfInformation", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DISCLOSURE_STATUS = new TSE_T_CG(
        "SupplementaryInformationDisclosureStatus", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_DISCLOSURE_STATUS_CHECK = new TSE_T_CG(
        "SupplementaryInformationDisclosureStatusCheck", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_ELECTRONIC_EXECUTION = new TSE_T_CG(
        "SupplementaryInformationElectronicExecution", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_FOREIGN_INVESTORS = new TSE_T_CG(
        "SupplementaryInformationForeignInvestors", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_GRANTEES_OF_STOCK_OPTIONS = new TSE_T_CG(
        "SupplementaryInformationGranteesOfStockOptions", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_GRANTEES_OF_STOCK_OPTIONS_CHECK = new TSE_T_CG(
        "SupplementaryInformationGranteesOfStockOptionsCheck", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_IRDIVISIONS = new TSE_T_CG(
        "SupplementaryInformationIRDivisions", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_INCENTIVES = new TSE_T_CG(
        "SupplementaryInformationIncentives", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_INCENTIVES_CHECK = new TSE_T_CG(
        "SupplementaryInformationIncentivesCheck", 
        "Supplementary information", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_INDIVIDUAL_INVESTORS = new TSE_T_CG(
        "SupplementaryInformationIndividualInvestors", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_INTERNAL_REGULATIONS = new TSE_T_CG(
        "SupplementaryInformationInternalRegulations", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OF_THE_ABOVE = new TSE_T_CG(
        "SupplementaryInformationOfTheAbove", 
        "Supplementary information of the above", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OF_THE_ABOVE_CHECK = new TSE_T_CG(
        "SupplementaryInformationOfTheAboveCheck", 
        "Supplementary information of the above", 
        "該当項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OTHER_IR = new TSE_T_CG(
        "SupplementaryInformationOtherIR", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OTHER_SHAREHOLDERS_MEETING = new TSE_T_CG(
        "SupplementaryInformationOtherShareholdersMeeting", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OTHER_STAKEHOLDERS = new TSE_T_CG(
        "SupplementaryInformationOtherStakeholders", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "SupplementaryInformationOutsideCorporateAuditors", 
        "Supplementary information", 
        "適合項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_OUTSIDE_DIRECTORS = new TSE_T_CG(
        "SupplementaryInformationOutsideDirectors", 
        "Supplementary information", 
        "適合項目に関する補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_PARTICIPATION_IN_ELECTRONIC_VOTING_PLATFORMS_AND_OTHER_ACTIVITIES_TO_IMPROVE_VOTING_ENVIRONMENT_FOR_INSTITUTIONAL_INVESTORS = new TSE_T_CG(
        ...
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_PUBLIC_ANNOUNCEMENT_OF_DISCLOSURE_POLICY = new TSE_T_CG(
        "SupplementaryInformationPublicAnnouncementOfDisclosurePolicy", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_SHAREHOLDERS_MEETING = new TSE_T_CG(
        "SupplementaryInformationShareholdersMeeting", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPLEMENTARY_INFORMATION_WEBSITE = new TSE_T_CG(
        "SupplementaryInformationWebsite", 
        "Supplementary information", 
        "補足説明");
    public static final TSE_T_CG SUPPORT_SYSTEM_FOR_OUTSIDE_DIRECTORS_OUTSIDE_CORPORATE_AUDITORS = new TSE_T_CG(
        "SupportSystemForOutsideDirectorsOutsideCorporateAuditors", 
        "Support system for outside directors (outside corporate auditors)", 
        "社外取締役（社外監査役）のサポート体制");
    public static final TSE_T_CG SUPPORT_SYSTEM_FOR_OUTSIDE_DIRECTORS_OUTSIDE_CORPORATE_AUDITORS_CHECK = new TSE_T_CG(
        "SupportSystemForOutsideDirectorsOutsideCorporateAuditorsCheck", 
        "Support system for outside directors (outside corporate auditors)", 
        "社外取締役（社外監査役）のサポート体制");
    public static final TSE_T_CG TERM_RETIRED_PRESIDENTS_OR_CEOS_HOLDING_ADVISORY_POSITIONS = new TSE_T_CG(
        "TermRetiredPresidentsOrCEOsHoldingAdvisoryPositions", 
        "Term", 
        "任期");
    public static final TSE_T_CG TOKYO_1ST_SECTION = new TSE_T_CG(
        "Tokyo1stSection", 
        "Tokyo 1st section", 
        "東京 第一部");
    public static final TSE_T_CG TOKYO_2ND_SECTION = new TSE_T_CG(
        "Tokyo2ndSection", 
        "Tokyo 2nd section", 
        "東京 第二部");
    public static final TSE_T_CG TOKYO_JASDAQ = new TSE_T_CG(
        "TokyoJASDAQ", 
        "Tokyo JASDAQ", 
        "東京 JASDAQ");
    public static final TSE_T_CG TOKYO_MOTHERS = new TSE_T_CG(
        "TokyoMothers", 
        "Tokyo Mothers", 
        "東京 マザーズ");
    public static final TSE_T_CG TOKYO_STOCK_EXCHANGE_PARENT_COMPANY = new TSE_T_CG(
        "TokyoStockExchangeParentCompany", 
        "Tokyo", 
        "東京");
    public static final TSE_T_CG TOKYO_TO_BE_LISTED = new TSE_T_CG(
        "TokyoToBeListed", 
        "Tokyo (to be listed)", 
        "東京 （未定）");
    public static final TSE_T_CG URL = new TSE_T_CG(
        "URL", 
        "URL", 
        "URL");
    ;
    
    private TSE_T_CG(String name, String en, String ja) {
        super(NAMESPACE, name, en, ja);
    }
    
    public static final Set<TSE_T_CG> ALL = new TreeSet<>();
    static {
