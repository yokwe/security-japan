...
public enum TSE_RE_T {
    ...
    ASSET_MANAGER_REIT (
        ...
        "Asset manager", 
        "資産運用会社名"), 
    BUSINESS_RESULTS_CASH_FLOWS_REITHEADING (
        "BusinessResultsCashFlowsREITHeading", 
        "Cash flows", 
        "キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_CASH_FLOWS_REITLINE_ITEMS (
        "BusinessResultsCashFlowsREITLineItems", 
        "Cash flows", 
        "キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_CASH_FLOWS_REITTABLE (
        "BusinessResultsCashFlowsREITTable", 
        "Cash flows", 
        "キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_DISTRIBUTIONS_REITHEADING (
        "BusinessResultsDistributionsREITHeading", 
        "Distributions", 
        "分配状況"), 
    BUSINESS_RESULTS_DISTRIBUTIONS_REITLINE_ITEMS (
        "BusinessResultsDistributionsREITLineItems", 
        "Distributions", 
        "分配状況"), 
    BUSINESS_RESULTS_DISTRIBUTIONS_REITTABLE (
        "BusinessResultsDistributionsREITTable", 
        "Distributions", 
        "分配状況"), 
    BUSINESS_RESULTS_FINANCIAL_POSITIONS_REITHEADING (
        "BusinessResultsFinancialPositionsREITHeading", 
        "Financial positions", 
        "財政状態"), 
    BUSINESS_RESULTS_FINANCIAL_POSITIONS_REITLINE_ITEMS (
        "BusinessResultsFinancialPositionsREITLineItems", 
        "Financial positions", 
        "財政状態"), 
    BUSINESS_RESULTS_FINANCIAL_POSITIONS_REITTABLE (
        "BusinessResultsFinancialPositionsREITTable", 
        "Financial positions", 
        "財政状態"), 
    BUSINESS_RESULTS_INTERIM_CASH_FLOWS_REITHEADING (
        "BusinessResultsInterimCashFlowsREITHeading", 
        "Interim cash flows", 
        "中間期キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_INTERIM_CASH_FLOWS_REITLINE_ITEMS (
        "BusinessResultsInterimCashFlowsREITLineItems", 
        "Interim cash flows", 
        "中間期キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_INTERIM_CASH_FLOWS_REITTABLE (
        "BusinessResultsInterimCashFlowsREITTable", 
        "Interim cash flows", 
        "中間期キャッシュ・フローの状況"), 
    BUSINESS_RESULTS_INTERIM_FINANCIAL_POSITIONS_REITHEADING (
        "BusinessResultsInterimFinancialPositionsREITHeading", 
        "Interim financial positions", 
        "中間期財政状態"), 
    BUSINESS_RESULTS_INTERIM_FINANCIAL_POSITIONS_REITLINE_ITEMS (
        "BusinessResultsInterimFinancialPositionsREITLineItems", 
        "Interim financial positions", 
        "中間期財政状態"), 
    BUSINESS_RESULTS_INTERIM_FINANCIAL_POSITIONS_REITTABLE (
        "BusinessResultsInterimFinancialPositionsREITTable", 
        "Interim financial positions", 
        "中間期財政状態"), 
    BUSINESS_RESULTS_INTERIM_OPERATING_RESULTS_REITHEADING (
        "BusinessResultsInterimOperatingResultsREITHeading", 
        "Interim operating results", 
        "中間期運用状況"), 
    BUSINESS_RESULTS_INTERIM_OPERATING_RESULTS_REITLINE_ITEMS (
        "BusinessResultsInterimOperatingResultsREITLineItems", 
        "Interim operating results", 
        "中間期運用状況"), 
    BUSINESS_RESULTS_INTERIM_OPERATING_RESULTS_REITTABLE (
        "BusinessResultsInterimOperatingResultsREITTable", 
        "Interim operating results", 
        "中間期運用状況"), 
    BUSINESS_RESULTS_OPERATING_RESULTS_REITHEADING (
        "BusinessResultsOperatingResultsREITHeading", 
        "Operating results", 
        "運用状況"), 
    BUSINESS_RESULTS_OPERATING_RESULTS_REITLINE_ITEMS (
        "BusinessResultsOperatingResultsREITLineItems", 
        "Operating results", 
        "運用状況"), 
    BUSINESS_RESULTS_OPERATING_RESULTS_REITTABLE (
    ...
    CASH_AND_EQUIVALENTS_END_OF_PERIOD (
        ...
        "現金及び現金同等物期末残高"), 
    CASH_DISTRIBUTIONS_REITABSTRACT (
    ...
    CONVENING_BRIEFING_OF_RESULTS_REIT (
        ...
        "決算説明会開催の有無"), 
    CORRECTION_DETAIL_REITABSTRACT (
    ...
    CURRENT_MEMBER (
        ...
        "Current", 
        "今回"), 
    DISTRIBUTION_FORECAST_CORRECTION_REITABSTRACT (
        "DistributionForecastCorrectionREITAbstract", 
        "Distribution forecast correction", 
        "分配予想の修正について"), 
    DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_PER_UNIT_FORECAST_REITABSTRACT (
    ...
    DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_PER_UNIT_REIT (
        ...
        "Distributions in excess of profit per unit", 
        "1口当たり利益超過分配金"), 
    DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_PER_UNIT_REITABSTRACT (
    ...
    DISTRIBUTIONS_PAYABLE_DATE_AS_PLANNED_REIT (
        ...
        "分配金支払開始予定日"), 
    DISTRIBUTIONS_PER_UNIT_EXCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_FORECAST_REITABSTRACT (
    ...
    DISTRIBUTIONS_PER_UNIT_EXCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REIT (
        ...
        "Distributions per unit (excluding distributions in excess of profit)", 
        "1口当たり分配金（利益超過分配金は含まない）"), 
    DISTRIBUTIONS_PER_UNIT_EXCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REITABSTRACT (
        "DistributionsPerUnitExcludingDistributionsInExcessOfProfitREITAbstract", 
        "Distributions per unit (excluding distributions in excess of profit)", 
        "1口当たり分配金（利益超過分配金は含まない）"), 
    DISTRIBUTIONS_PER_UNIT_INCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_FORECAST_REITABSTRACT (
    ...
    DISTRIBUTIONS_PER_UNIT_INCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REIT (
        ...
        "Distributions per unit (including distributions in excess of profit)", 
        "1口当たり分配金（利益超過分配金を含む）"), 
    DISTRIBUTIONS_PER_UNIT_INCLUDING_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REITABSTRACT (
        "DistributionsPerUnitIncludingDistributionsInExcessOfProfitREITAbstract", 
        "Distributions per unit (including distributions in excess of profit)", 
        "1口当たり分配金（利益超過分配金を含む）"), 
    DISTRIBUTIONS_PER_UNIT_REITABSTRACT (
        "DistributionsPerUnitREITAbstract", 
        "Distributions per unit", 
        "分配金"), 
    DISTRIBUTIONS_REITABSTRACT (
        "DistributionsREITAbstract", 
        "Distributions", 
        "分配状況"), 
    DOCUMENT_ENTITY_INFORMATION_REITHEADING (
        "DocumentEntityInformationREITHeading", 
        "Submitter information", 
        "提出者情報"), 
    DOCUMENT_ENTITY_INFORMATION_REITLINE_ITEMS (
        "DocumentEntityInformationREITLineItems", 
        "Submitter information", 
        "提出者情報"), 
    DOCUMENT_ENTITY_INFORMATION_REITTABLE (
    ...
    FISCAL_YEAR_END (
        ...
        "Fiscal Year End", 
        "決算期"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_INTERIM_REITHEADING (
        "ForecastCorrectionOfOperatingResultsInterimREITHeading", 
        "Forecast correction", 
        "中間期運用状況の予想数値の修正"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_INTERIM_REITLINE_ITEMS (
        "ForecastCorrectionOfOperatingResultsInterimREITLineItems", 
        "Forecast correction", 
        "中間期運用状況の予想数値の修正"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_INTERIM_REITTABLE (
        "ForecastCorrectionOfOperatingResultsInterimREITTable", 
        "Forecast correction", 
        "中間期運用状況の予想数値の修正"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITABSTRACT (
        "ForecastCorrectionOfOperatingResultsREITAbstract", 
        "Forecast correction", 
        "運用状況の予想の修正について"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITHEADING (
        "ForecastCorrectionOfOperatingResultsREITHeading", 
        "Forecast correction", 
        "運用状況の予想数値の修正"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITLINE_ITEMS (
        "ForecastCorrectionOfOperatingResultsREITLineItems", 
        "Forecast correction", 
        "運用状況の予想数値の修正"), 
    FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITTABLE (
    ...
    FORECAST_MEMBER (
        ...
        "Forecast", 
        "予想"), 
    FORECASTS_REITHEADING (
        "ForecastsREITHeading", 
        "Forecasts", 
        "運用状況の予想"), 
    FORECASTS_REITLINE_ITEMS (
    ...
    INQUIRIES_ABSTRACT (
        ...
        "Inquiries", 
        "問合せ先責任者"), 
    INTERIM_FORECASTS_REITHEADING (
        "InterimForecastsREITHeading", 
        "Interim forecasts", 
        "中間期運用状況の予想"), 
    INTERIM_FORECASTS_REITLINE_ITEMS (
        "InterimForecastsREITLineItems", 
        "Interim forecasts", 
        "中間期運用状況の予想"), 
    INTERIM_FORECASTS_REITTABLE (
    ...
    LOWER_MEMBER (
        ...
        "Lower", 
        "下限"), 
    MAIN_TABLE_OF_FORECASTS_OF_OPERATING_RESULTS_INTERIM_REITABSTRACT (
        "MainTableOfForecastsOfOperatingResultsInterimREITAbstract", 
        "Main table of forecasts", 
        "中間期運用状況予想本表"), 
    MAIN_TABLE_OF_FORECASTS_OF_OPERATING_RESULTS_REITABSTRACT (
        "MainTableOfForecastsOfOperatingResultsREITAbstract", 
        "Main table of forecasts", 
        "当期運用状況予想本表"), 
    MAIN_TABLE_OF_FORECASTS_REITABSTRACT (
        "MainTableOfForecastsREITAbstract", 
        "Main table of forecasts", 
        "運用状況の予想本表"), 
    MAIN_TABLE_OF_NEXT_FORECASTS_OF_OPERATING_RESULTS_REITABSTRACT (
    ...
    NET_INCOME_FORECAST_ABSTRACT (
        ...
        "Profit", 
        "当期純利益"), 
    NET_INCOME_PER_UNIT_CORRECTION_REITABSTRACT (
    ...
    NET_INCOME_TO_UNITHOLDERS_EQUITY_RATIO_REIT (
        ...
        "自己資本当期純利益率"), 
    NEXT_FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITHEADING (
        "NextForecastCorrectionOfOperatingResultsREITHeading", 
        "Forecast correction", 
        "次期運用状況の予想数値の修正"), 
    NEXT_FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITLINE_ITEMS (
        "NextForecastCorrectionOfOperatingResultsREITLineItems", 
        "Forecast correction", 
        "次期運用状況の予想数値の修正"), 
    NEXT_FORECAST_CORRECTION_OF_OPERATING_RESULTS_REITTABLE (
        "NextForecastCorrectionOfOperatingResultsREITTable", 
        "Forecast correction", 
        "次期運用状況の予想数値の修正"), 
    NEXT_REVISED_DISTRIBUTION_FORECAST_REITHEADING (
        "NextRevisedDistributionForecastREITHeading", 
        "Revised distribution forecast", 
        "次期分配予想の修正について"), 
    NEXT_REVISED_DISTRIBUTION_FORECAST_REITLINE_ITEMS (
        "NextRevisedDistributionForecastREITLineItems", 
        "Revised distribution forecast", 
        "次期分配予想の修正について"), 
    NEXT_REVISED_DISTRIBUTION_FORECAST_REITTABLE (
    ...
    NON_CONSOLIDATED_MEMBER (
        ...
        "NonConsolidated", 
        "個別又は非連結"), 
    NOTE_AND_REASON_FOR_CORRECTION_REITABSTRACT (
        "NoteAndReasonForCorrectionREITAbstract", 
        "Note and reason for correction", 
        "運用状況の予想の修正に関する注記"), 
    NOTE_AND_REASON_FOR_CORRECTION_REITHEADING (
        "NoteAndReasonForCorrectionREITHeading", 
        "Note and reason for correction", 
        "運用状況の予想の修正に関する注記"), 
    NOTE_AND_REASON_FOR_CORRECTION_REITLINE_ITEMS (
        "NoteAndReasonForCorrectionREITLineItems", 
        "Note and reason for correction", 
        "運用状況の予想の修正に関する注記"), 
    NOTE_AND_REASON_FOR_CORRECTION_REITTABLE (
    ...
    NOTE_TO_DISTRIBUTIONS_REIT (
        ...
        "分配状況に関する注記"), 
    NOTE_TO_DISTRIBUTIONS_REITABSTRACT (
    ...
    NOTE_TO_FORECAST_CORRECTION_REIT (
        ...
        "Note to forecast", 
        "運用状況の予想の状況に関する注記"), 
    NOTE_TO_FORECAST_CORRECTION_REITABSTRACT (
    ...
    NOTE_TO_FORECASTS_REIT (
        ...
        "Note to forecasts", 
        "運用状況の予想に関する事項"), 
    NOTE_TO_FORECASTS_REITABSTRACT (
    ...
    NOTE_TO_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REIT (
        ...
        "発行済投資口の総口数に関する注記"), 
    NOTE_TO_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITABSTRACT (
    ...
    NOTE_TO_OPERATING_RESULTS_REIT (
        ...
        "運用状況に関する注記"), 
    NOTE_TO_OPERATING_RESULTS_REITABSTRACT (
        "NoteToOperatingResultsREITAbstract", 
        "Note to operating results", 
        "運用状況に関する注記"), 
    NOTE_TO_REVISED_DISTRIBUTION_FORECAST_REITHEADING (
        "NoteToRevisedDistributionForecastREITHeading", 
        "Note to revised distribution forecast", 
        "分配予想の修正に関する注記"), 
    NOTE_TO_REVISED_DISTRIBUTION_FORECAST_REITLINE_ITEMS (
        "NoteToRevisedDistributionForecastREITLineItems", 
        "Note to revised distribution forecast", 
        "分配予想の修正に関する注記"), 
    NOTE_TO_REVISED_DISTRIBUTION_FORECAST_REITTABLE (
        "NoteToRevisedDistributionForecastREITTable", 
        "Note to revised distribution forecast", 
        "分配予想の修正に関する注記"), 
    NOTES_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITHEADING (
        "NotesChangesAccountingPoliciesAccountingEstimatesRetrospectiveRestatementREITHeading", 
        "Changes in accounting policies and accounting estimates, retrospective restatement", 
        "会計方針の変更・会計上の見積りの変更・修正再表示"), 
    NOTES_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITLINE_ITEMS (
        "NotesChangesAccountingPoliciesAccountingEstimatesRetrospectiveRestatementREITLineItems", 
        "Changes in accounting policies and accounting estimates, retrospective restatement", 
        "会計方針の変更・会計上の見積りの変更・修正再表示"), 
    NOTES_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITTABLE (
    ...
    NOTES_INTERIM_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITHEADING (
        ...
        "会計方針の変更・会計上の見積りの変更・修正再表示"), 
    NOTES_INTERIM_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITLINE_ITEMS (
        "NotesInterimChangesAccountingPoliciesAccountingEstimatesRetrospectiveRestatementREITLineItems", 
        "Changes in accounting policies, accounting estimates and retrospective restatement", 
        "会計方針の変更・会計上の見積りの変更・修正再表示"), 
    NOTES_INTERIM_CHANGES_ACCOUNTING_POLICIES_ACCOUNTING_ESTIMATES_RETROSPECTIVE_RESTATEMENT_REITTABLE (
        "NotesInterimChangesAccountingPoliciesAccountingEstimatesRetrospectiveRestatementREITTable", 
        "Changes in accounting policies, accounting estimates and retrospective restatement", 
        "会計方針の変更・会計上の見積りの変更・修正再表示"), 
    NOTES_INTERIM_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITHEADING (
        "NotesInterimNumberOfInvestmentUnitsIssuedREITHeading", 
        "Number of investment units issued", 
        "発行済投資口の総口数"), 
    NOTES_INTERIM_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITLINE_ITEMS (
        "NotesInterimNumberOfInvestmentUnitsIssuedREITLineItems", 
        "Number of investment units issued", 
        "発行済投資口の総口数"), 
    NOTES_INTERIM_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITTABLE (
        "NotesInterimNumberOfInvestmentUnitsIssuedREITTable", 
        "Number of investment units issued", 
        "発行済投資口の総口数"), 
    NOTES_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITHEADING (
        "NotesNumberOfInvestmentUnitsIssuedREITHeading", 
        "Number of investment units issued", 
        "発行済投資口の総口数"), 
    NOTES_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITLINE_ITEMS (
        "NotesNumberOfInvestmentUnitsIssuedREITLineItems", 
        "Number of investment units issued", 
        "発行済投資口の総口数"), 
    NOTES_NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITTABLE (
    ...
    NUMBER_OF_INVESTMENT_UNITS_ISSUED_REITABSTRACT (
    ...
    OPERATING_INCOME_FORECAST_ABSTRACT (
        ...
        "Operating profit", 
        "営業利益"), 
    OPERATING_RESULTS_REITABSTRACT (
        "OperatingResultsREITAbstract", 
        "Operating results", 
        "運用状況"), 
    OPERATING_REVENUES_CORRECTION_REITABSTRACT (
        "OperatingRevenuesCorrectionREITAbstract", 
        "Operating revenues", 
        "営業収益"), 
    OPERATING_REVENUES_FORECAST_REITABSTRACT (
    ...
    OPERATING_REVENUES_REIT (
        ...
        "Operating revenues", 
        "営業収益"), 
    OPERATING_REVENUES_REITABSTRACT (
    ...
    ORDINARY_INCOME_TO_TOTAL_ASSETS_RATIO (
        ...
        "総資産経常利益率"), 
    OTHER_OPERATING_RESULTS_REITABSTRACT (
        "OtherOperatingResultsREITAbstract", 
        "Other operating results", 
        "その他の運用状況"), 
    OTHER_SUBMITTER_INFORMATION_REITABSTRACT (
    ...
    RATIO_OF_DISTRIBUTIONS_TO_NET_ASSETS_REIT (
        ...
        "純資産配当率"), 
    RATIO_OF_DISTRIBUTIONS_TO_NET_ASSETS_REITABSTRACT (
        "RatioOfDistributionsToNetAssetsREITAbstract", 
        "Ratio of distributions to net assets", 
        "純資産配当率"), 
    REASON_FOR_CORRECTION_DISTRIBUTION_FORECAST_CORRECTION_REITABSTRACT (
    ...
    REASON_FOR_FORECAST_CORRECTION_REIT (
        ...
        "運用状況の予想の修正の理由"), 
    REASON_FOR_FORECAST_CORRECTION_REITABSTRACT (
    ...
    REPRESENTATIVE_ABSTRACT (
        ...
        "Representative", 
        "代表者"), 
    REPRESENTATIVE_ASSET_MANAGER_REITABSTRACT (
    ...
    RETROSPECTIVE_RESTATEMENT (
        ...
        "修正再表示"), 
    REVISED_DISTRIBUTION_FORECAST_REITHEADING (
        "RevisedDistributionForecastREITHeading", 
        "Revised distribution forecast", 
        "分配予想の修正について"), 
    REVISED_DISTRIBUTION_FORECAST_REITLINE_ITEMS (
        "RevisedDistributionForecastREITLineItems", 
        "Revised distribution forecast", 
        "分配予想の修正について"), 
    REVISED_DISTRIBUTION_FORECAST_REITTABLE (
    ...
    SECURITIES_REPORT_FILING_DATE_AS_PLANNED_REIT (
        ...
        "有価証券報告書提出予定日"), 
    SPECIAL_NOTES_INTERIM_EARNING_DIGEST_SUMMARY_REITHEADING (
        "SpecialNotesInterimEarningDigestSummaryREITHeading", 
        "Interim special notes", 
        "中間期サマリー情報に関する注記"), 
    SPECIAL_NOTES_INTERIM_EARNING_DIGEST_SUMMARY_REITLINE_ITEMS (
        "SpecialNotesInterimEarningDigestSummaryREITLineItems", 
        "Interim special notes", 
        "中間期サマリー情報に関する注記"), 
    SPECIAL_NOTES_INTERIM_EARNING_DIGEST_SUMMARY_REITTABLE (
        "SpecialNotesInterimEarningDigestSummaryREITTable", 
        "Interim special notes", 
        "中間期サマリー情報に関する注記"), 
    SPECIAL_NOTES_REITHEADING (
        "SpecialNotesREITHeading", 
        "Special notes", 
        "サマリー情報に関する注記"), 
    SPECIAL_NOTES_REITLINE_ITEMS (
        "SpecialNotesREITLineItems", 
        "Special notes", 
        "サマリー情報に関する注記"), 
    SPECIAL_NOTES_REITTABLE (
    ...
    TOTAL_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REIT (
        ...
        "利益超過分配金総額"), 
    TOTAL_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REITABSTRACT (
    ...
    TOTAL_DISTRIBUTIONS_INCLUDING_TOTAL_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REIT (
        ...
        "分配金総額（利益超過分配金を含む）"), 
    TOTAL_DISTRIBUTIONS_INCLUDING_TOTAL_DISTRIBUTIONS_IN_EXCESS_OF_PROFIT_REITABSTRACT (
    ...
    TOTAL_DISTRIBUTIONS_REIT (
        ...
        "分配金総額（利益超過分配金は含まない）"), 
    TOTAL_DISTRIBUTIONS_REITABSTRACT (
    ...
    public static final Map<String, TSE_RE_T> NAME_MAP = new TreeMap<>();
    public static final TSE_RE_T get(String name) {
    ...
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(TSE_RE_T.class);
    private static void addNameMap(TSE_RE_T e) {
