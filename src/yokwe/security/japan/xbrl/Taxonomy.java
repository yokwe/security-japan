...
//			    <loc xlink:type="locator" xlink:href="tse-ed-t-2014-01-12.xsd#tse-ed-t_DividendPerShare" xlink:label="DividendPerShare"/>
				XMLUtil.buildStream(file).filter(o -> o.localName.equals("loc")).forEach(o -> locMap.put(o.getAttribute(XML.NS_XLINK, "href"), o.getAttribute(XML.NS_XLINK, "label")));
//			    <label xlink:type="resource" xlink:label="label_DividendPerShare" xlink:role="http://www.xbrl.org/2003/role/label" xml:lang="ja" id="label_DividendPerShare">1株当たり配当金</label>
				XMLUtil.buildStream(file).filter(o -> o.localName.equals("label")).forEach(o -> labelMap.put(o.getAttribute(XML.NS_XLINK, "label"), o.content));
//			    <labelArc xlink:type="arc" xlink:arcrole="http://www.xbrl.org/2003/arcrole/concept-label" xlink:from="DividendPerShare" xlink:to="label_DividendPerShare"/>
				XMLUtil.buildStream(file).filter(o -> o.localName.equals("labelArc")).forEach(o -> arcMap.put(o.getAttribute(XML.NS_XLINK, "from"), o.getAttribute(XML.NS_XLINK, "to")));
